window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = "._7FyZ_G_card{flex-direction:column;gap:8px;display:flex}._7FyZ_G_row{align-items:center;min-height:32px;display:flex}._7FyZ_G_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}._7FyZ_G_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}._7FyZ_G_separator{corner-shape:round;background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}._7FyZ_G_summary,._7FyZ_G_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}._7FyZ_G_error{color:var(--dsw-alias-state-error-primary)}._7FyZ_G_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}._7FyZ_G_card[data-cordis-status=awaiting-approval] ._7FyZ_G_status,._7FyZ_G_card[data-cordis-status=client-pending] ._7FyZ_G_status{color:var(--dsw-alias-state-warn-label)}._7FyZ_G_card[data-cordis-status=running] ._7FyZ_G_status{color:var(--dsw-alias-state-success-primary)}._7FyZ_G_card[data-cordis-status=failed] ._7FyZ_G_status{color:var(--dsw-alias-state-error-primary)}._7FyZ_G_inspect{corner-shape:round;width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}._7FyZ_G_card:hover ._7FyZ_G_inspect,._7FyZ_G_inspect:focus-visible{opacity:1}._7FyZ_G_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}._7FyZ_G_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}._7FyZ_G_business{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}._7FyZ_G_output{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}._7FyZ_G_business ._7FyZ_G_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"business": "_7FyZ_G_business",
			"card": "_7FyZ_G_card",
			"error": "_7FyZ_G_error",
			"icon": "_7FyZ_G_icon",
			"inspect": "_7FyZ_G_inspect",
			"message": "_7FyZ_G_message",
			"output": "_7FyZ_G_output",
			"row": "_7FyZ_G_row",
			"separator": "_7FyZ_G_separator",
			"status": "_7FyZ_G_status",
			"summary": "_7FyZ_G_summary",
			"title": "_7FyZ_G_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".VxAhKa_card{flex-direction:column;display:flex}.VxAhKa_card .VxAhKa_title,.VxAhKa_card .VxAhKa_chevron{color:var(--dsw-alias-state-business-primary)}.VxAhKa_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.VxAhKa_row{gap:0}.VxAhKa_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.VxAhKa_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.VxAhKa_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.VxAhKa_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.VxAhKa_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.VxAhKa_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.VxAhKa_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.VxAhKa_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.VxAhKa_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.VxAhKa_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.VxAhKa_switch{height:22px;padding:0 8px;font-size:12px}.VxAhKa_card[data-terminal] .VxAhKa_title,.VxAhKa_card[data-terminal] .VxAhKa_name,.VxAhKa_card[data-terminal] .VxAhKa_purpose,.VxAhKa_card[data-terminal] .VxAhKa_statusLabel{color:var(--dsw-alias-label-caption)}.VxAhKa_card[data-terminal] .VxAhKa_separator{background:var(--dsw-alias-label-caption)}.VxAhKa_bodyWrap{flex-direction:column;display:flex}.VxAhKa_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.VxAhKa_sourceTabs{border-bottom:.5px solid var(--dsw-alias-border-l2);height:32px;display:flex}.VxAhKa_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.VxAhKa_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.VxAhKa_sourceTab:disabled{cursor:default;opacity:.4}.VxAhKa_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.VxAhKa_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.VxAhKa_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.VxAhKa_sourcePanel{max-height:260px;overflow:auto}.VxAhKa_sourceCode{margin:0}.VxAhKa_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.VxAhKa_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.VxAhKa_output{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.VxAhKa_output[data-error]{color:var(--dsw-alias-state-error-primary)}.VxAhKa_inspectButton{border:.5px solid var(--dsw-alias-border-l4);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.VxAhKa_card:hover .VxAhKa_inspectButton,.VxAhKa_inspectButton:focus-visible{opacity:1}.VxAhKa_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.VxAhKa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.VxAhKa_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"approvalPrompt": "VxAhKa_approvalPrompt",
			"bodyWrap": "VxAhKa_bodyWrap",
			"card": "VxAhKa_card",
			"chevron": "VxAhKa_chevron",
			"codeSection": "VxAhKa_codeSection",
			"errorSummary": "VxAhKa_errorSummary",
			"inspectButton": "VxAhKa_inspectButton",
			"name": "VxAhKa_name",
			"notice": "VxAhKa_notice",
			"output": "VxAhKa_output",
			"panelHint": "VxAhKa_panelHint",
			"purpose": "VxAhKa_purpose",
			"readout": "VxAhKa_readout",
			"requestError": "VxAhKa_requestError",
			"row": "VxAhKa_row",
			"sectionLabel": "VxAhKa_sectionLabel",
			"separator": "VxAhKa_separator",
			"sourceCard": "VxAhKa_sourceCard",
			"sourceCode": "VxAhKa_sourceCode",
			"sourcePanel": "VxAhKa_sourcePanel",
			"sourceTab": "VxAhKa_sourceTab",
			"sourceTabActive": "VxAhKa_sourceTabActive",
			"sourceTabs": "VxAhKa_sourceTabs",
			"statusLabel": "VxAhKa_statusLabel",
			"switch": "VxAhKa_switch",
			"title": "VxAhKa_title",
			"visuallyHidden": "VxAhKa_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".bAomMq_layer{flex:none;align-items:center;width:100%;height:42px;margin:8px 0 0;display:flex;position:relative}.bAomMq_footerButtons{align-items:center;width:100%;display:flex}.bAomMq_badge{width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;margin:0 -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.bAomMq_badge:hover,.bAomMq_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.bAomMq_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.bAomMq_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.bAomMq_layer.bAomMq_rail{width:36px;height:36px;margin:0}.bAomMq_rail .bAomMq_badge{corner-shape:round;border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.bAomMq_rail .bAomMq_footerButtons{flex-direction:column;gap:2px}.bAomMq_panel{z-index:30;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:12px;flex-direction:column;display:flex;position:fixed;overflow:hidden}.bAomMq_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.bAomMq_body{flex:1;min-height:0;padding:0 12px 12px;overflow-y:auto}.bAomMq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:20px}.bAomMq_note,.bAomMq_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.bAomMq_readError{color:var(--dsw-alias-state-error-primary)}.bAomMq_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0;font-size:11px;font-weight:500;line-height:16px}.bAomMq_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.bAomMq_row{border:.5px solid var(--dsw-alias-border-l4);border-radius:12px;flex-direction:column;gap:8px;padding:14px 12px 10px;display:flex}.bAomMq_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.bAomMq_rowHead{align-items:center;gap:8px;display:flex}.bAomMq_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.bAomMq_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.bAomMq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.bAomMq_row[data-cordis-status=idle] .bAomMq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.bAomMq_row[data-cordis-status=awaiting-approval] .bAomMq_rowStatus,.bAomMq_row[data-cordis-status=client-pending] .bAomMq_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.bAomMq_row[data-cordis-status=failed] .bAomMq_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.bAomMq_row[data-cordis-status=running] .bAomMq_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.bAomMq_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.bAomMq_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.bAomMq_versionPicker select{border:.5px solid var(--dsw-alias-border-l3);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;background:0 0;border-radius:7px;flex:1;padding:0 8px}.bAomMq_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.bAomMq_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.bAomMq_rowActions{flex:none;align-items:center;gap:10px;display:flex}.bAomMq_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.bAomMq_transitionActions{gap:6px;margin-left:auto;display:flex}.bAomMq_transitionActions button{border:.5px solid var(--dsw-alias-border-l3);corner-shape:round;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.bAomMq_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.bAomMq_transitionActions button:disabled{opacity:.4;cursor:default}.bAomMq_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.bAomMq_actionButton{corner-shape:round;width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.bAomMq_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.bAomMq_actionButton:disabled{opacity:.4;cursor:default}.bAomMq_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.bAomMq_doubleCheck svg{position:absolute;top:1px}.bAomMq_doubleCheck svg:first-child{opacity:.7;left:0}.bAomMq_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"actionButton": "bAomMq_actionButton",
			"activeVersion": "bAomMq_activeVersion",
			"badge": "bAomMq_badge",
			"badgeCount": "bAomMq_badgeCount",
			"badgeLabel": "bAomMq_badgeLabel",
			"body": "bAomMq_body",
			"doubleCheck": "bAomMq_doubleCheck",
			"footerButtons": "bAomMq_footerButtons",
			"group": "bAomMq_group",
			"header": "bAomMq_header",
			"layer": "bAomMq_layer",
			"note": "bAomMq_note",
			"panel": "bAomMq_panel",
			"rail": "bAomMq_rail",
			"readError": "bAomMq_readError",
			"row": "bAomMq_row",
			"rowActions": "bAomMq_rowActions",
			"rowDetail": "bAomMq_rowDetail",
			"rowError": "bAomMq_rowError",
			"rowHead": "bAomMq_rowHead",
			"rowId": "bAomMq_rowId",
			"rowName": "bAomMq_rowName",
			"rowPurpose": "bAomMq_rowPurpose",
			"rowStatus": "bAomMq_rowStatus",
			"rows": "bAomMq_rows",
			"title": "bAomMq_title",
			"transition": "bAomMq_transition",
			"transitionActions": "bAomMq_transitionActions",
			"versionPicker": "bAomMq_versionPicker"
		};
		//#endregion
