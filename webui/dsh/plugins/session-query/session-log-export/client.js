window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/session-query/session-log-export/src/client/HeaderAction.module.css.mjs
		const css = ".E6ndFG_moreButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:28px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex}.E6ndFG_moreButton svg{width:15px;height:15px}.E6ndFG_moreButton:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var HeaderAction_module_css_default = { "moreButton": "E6ndFG_moreButton" };
		//#endregion
