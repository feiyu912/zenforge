window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-settings-general/src/client/SettingsRoot.module.css.mjs
		const css$4 = ".ybNn1W_triggerRow{flex:none;align-items:center;gap:8px;width:calc(100% + 4px);margin:4px -2px;display:flex;position:relative}.ybNn1W_triggerRow.ybNn1W_railRow{width:36px;margin:8px 0 10px}.ybNn1W_trigger{box-sizing:border-box;cursor:pointer;width:auto;min-width:0;height:42px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:1;align-items:center;gap:8px;margin:0;padding:0 10px 0 8px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}.ybNn1W_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.ybNn1W_trigger.ybNn1W_rail{flex:none;justify-content:center;gap:0;width:36px;height:36px;margin:0;padding:0}.ybNn1W_triggerLabel{white-space:nowrap;overflow:hidden}.ybNn1W_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.ybNn1W_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.ybNn1W_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:32px;display:flex;position:relative;overflow:hidden}.ybNn1W_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}.ybNn1W_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}.ybNn1W_navList{flex-direction:column;gap:4px;display:flex}.ybNn1W_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}.ybNn1W_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}.ybNn1W_navCell.ybNn1W_active{background:var(--dsw-specific-sidebar-nav-item-active)}.ybNn1W_navIcon{flex:none}.ybNn1W_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}.ybNn1W_content{flex-direction:column;flex:1;min-width:0;display:flex}.ybNn1W_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}.ybNn1W_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}.ybNn1W_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}.ybNn1W_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.ybNn1W_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}.ybNn1W_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"actions": "ybNn1W_actions",
			"active": "ybNn1W_active",
			"close": "ybNn1W_close",
			"content": "ybNn1W_content",
			"header": "ybNn1W_header",
			"hiddenLabel": "ybNn1W_hiddenLabel",
			"mask": "ybNn1W_mask",
			"nav": "ybNn1W_nav",
			"navCell": "ybNn1W_navCell",
			"navIcon": "ybNn1W_navIcon",
			"navLabel": "ybNn1W_navLabel",
			"navList": "ybNn1W_navList",
			"navTitle": "ybNn1W_navTitle",
			"options": "ybNn1W_options",
			"overlay": "ybNn1W_overlay",
			"panel": "ybNn1W_panel",
			"rail": "ybNn1W_rail",
			"railRow": "ybNn1W_railRow",
			"trigger": "ybNn1W_trigger",
			"triggerLabel": "ybNn1W_triggerLabel",
			"triggerRow": "ybNn1W_triggerRow"
		};
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-settings-general/src/client/DesktopUpdateIndicator.module.css.mjs
		const css$3 = "._RkXtW_indicator{border:1px solid color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 20%, transparent);color:var(--dsw-alias-brand-primary-new-colorprimary-new-color);background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 8%, transparent);font:inherit;white-space:nowrap;cursor:pointer;border-radius:6px;flex:none;align-items:center;gap:6px;margin-inline-end:4px;padding:1px 8px;font-size:12px;line-height:20px;display:inline-flex}._RkXtW_indicator[data-error]{color:var(--dsw-alias-state-error-primary)}._RkXtW_badge{inset-inline-end:2px;corner-shape:round;background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);border-radius:50%;width:6px;height:6px;position:absolute;top:2px}._RkXtW_badge[data-error],._RkXtW_errorDot{background:var(--dsw-alias-state-error-primary)}._RkXtW_errorDot{corner-shape:round;border-radius:50%;width:6px;height:6px}._RkXtW_spinner{animation:1s linear infinite _RkXtW_spin}@keyframes _RkXtW_spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){._RkXtW_spinner{animation:none}}._RkXtW_indicator[aria-disabled=true]{cursor:default}";
		const tagId$3 = "@deepseek-ai/dsh-client-ui-settings-general/DesktopUpdateIndicator.module.css";
		...
		var DesktopUpdateIndicator_module_css_default = {
			"badge": "_RkXtW_badge",
			"errorDot": "_RkXtW_errorDot",
			"indicator": "_RkXtW_indicator",
			"spin": "_RkXtW_spin",
			"spinner": "_RkXtW_spinner"
		};
		//#endregion
			...
			return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
				...
				children: (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [error ? (0, react_jsx_runtime.jsx)("span", {
						...
						"aria-hidden": "true"
					}) : busy ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLoadingOutline16, {
						className: DesktopUpdateIndicator_module_css_default.spinner,
						size: 16
					}) : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconDownloadOutline16, { size: 14 }), (0, react_jsx_runtime.jsx)("span", { children: label })]
				})
			});
		}
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-settings-general/src/client/chrome.module.css.mjs
		const css$2 = "._0e50Xa_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "_0e50Xa_triggerLabel" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-settings-general/src/client/GeneralSection.module.css.mjs
		const css$1 = ".YS2iha_section{flex-direction:column;width:100%;display:flex}.YS2iha_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "YS2iha_section" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-settings-general/src/client/SettingsDocumentAction.module.css.mjs
		const css = ".tF0V2a_action{align-items:center;gap:8px;min-width:0;display:flex}.tF0V2a_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
