window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-open-in-app/src/client/OpenInAppAction.module.css.mjs
		const css = ".mjU0Ea_split{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);height:28px;font-family:var(--dsw-font-family);border-radius:14px;align-items:stretch;display:inline-flex;overflow:hidden}.mjU0Ea_main,.mjU0Ea_chevron{color:var(--dsw-alias-label-primary);cursor:pointer;white-space:nowrap;background:0 0;border:0;align-items:center;gap:5px;font-size:11px;font-weight:400;line-height:16px;display:inline-flex}.mjU0Ea_main{padding:5px 6px 5px 7px}.mjU0Ea_main:hover:not(:disabled),.mjU0Ea_main:focus-visible,.mjU0Ea_chevron:hover,.mjU0Ea_chevron:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.mjU0Ea_main:disabled{color:var(--dsw-alias-label-dimmed);cursor:wait}.mjU0Ea_main[data-state=error]{color:var(--dsw-alias-state-error-primary);box-shadow:inset 0 0 0 1px var(--dsw-alias-state-error-primary)}.mjU0Ea_chevron{border-left:.5px solid var(--dsw-alias-border-l4);color:var(--dsw-alias-label-secondary);padding:5px 6px 5px 4px}.mjU0Ea_icon{flex:none}img.mjU0Ea_icon{object-fit:contain;user-select:none;display:block}";
