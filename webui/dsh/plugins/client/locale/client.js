window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/locale/src/client/LanguageRow.module.css.mjs
		const css = "._3Asriq_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}._3Asriq_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}._3Asriq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._3Asriq_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}._3Asriq_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}._3Asriq_chevron{flex:none}";
		...
		var LanguageRow_module_css_default = {
			"chevron": "_3Asriq_chevron",
			"row": "_3Asriq_row",
			"rowText": "_3Asriq_rowText",
			"selector": "_3Asriq_selector",
			"title": "_3Asriq_title"
		};
		//#endregion
