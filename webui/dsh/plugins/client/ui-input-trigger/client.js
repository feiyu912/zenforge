window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-input-trigger/src/client/MenuView.module.css.mjs
		const css = ".hzyPdq_menu{z-index:100;box-sizing:border-box;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsh-scrollbar-width:10px;--dsh-scrollbar-thumb-border:3px;--dsh-scrollbar-track-margin:12px;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);max-height:400px;box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;right:0;overflow:hidden}.hzyPdq_menu[data-overflow-below]:after{content:\"\";background:linear-gradient(to bottom, transparent, var(--dsw-specific-menu));pointer-events:none;height:16px;position:absolute;bottom:4px;left:4px;right:14px}.hzyPdq_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.hzyPdq_item{cursor:pointer;width:100%;min-height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:8px 10px;font-size:14px;line-height:22px;display:flex}.hzyPdq_item.hzyPdq_active{background:var(--dsw-alias-interactive-bg-hover)}.hzyPdq_sectionTitle{min-height:26px;color:var(--dsw-alias-label-tertiary);flex:none;padding:6px 10px 2px;font-size:12px;font-weight:500;line-height:18px}.hzyPdq_sectionTitle:not(:first-child){margin-top:4px}.hzyPdq_itemIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.hzyPdq_itemName{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}.hzyPdq_itemAlias{text-overflow:ellipsis;white-space:nowrap;max-width:20%;color:var(--dsw-alias-label-tertiary);flex:none;overflow:hidden}.hzyPdq_itemDescription{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}.hzyPdq_trailing{flex:none;align-items:center;gap:4px;margin-left:auto;display:inline-flex}.hzyPdq_drillHintText{color:var(--dsw-alias-label-caption);white-space:nowrap;font-size:11px;line-height:18px;display:none}.hzyPdq_drillHint{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-caption);border-radius:4px;padding:0 5px;font-family:inherit;font-size:11px;line-height:18px;display:none}.hzyPdq_item.hzyPdq_active .hzyPdq_drillHintText,.hzyPdq_item.hzyPdq_active .hzyPdq_drillHint{display:inline-flex}.hzyPdq_drill{width:20px;height:20px;color:var(--dsw-alias-label-caption);border-radius:4px;flex:none;place-items:center;display:inline-grid}.hzyPdq_drill:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.hzyPdq_groupTitle{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px;line-height:16px}.hzyPdq_skeletonRow{box-sizing:border-box;align-items:center;min-height:40px;padding:8px 10px;display:flex}.hzyPdq_skeletonBar{background:var(--dsw-alias-bg-skeleton);border-radius:4px;height:20px;animation:2s cubic-bezier(.36,0,.64,1) infinite hzyPdq_dsh-menu-skeleton}@keyframes hzyPdq_dsh-menu-skeleton{0%{opacity:1}40%{opacity:.6}80%,to{opacity:1}}.hzyPdq_crumbs{border-bottom:.5px solid var(--dsw-alias-border-l1);flex-wrap:wrap;flex:none;align-items:center;gap:2px;margin-bottom:2px;padding:4px 4px 6px;display:flex}.hzyPdq_crumb{max-width:40%;color:var(--dsw-alias-label-tertiary);cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:6px;flex:0 auto;padding:2px 6px;font-family:inherit;font-size:12px;line-height:18px;overflow:hidden}.hzyPdq_crumb:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.hzyPdq_crumbCurrent,.hzyPdq_crumbCurrent:hover{color:var(--dsw-alias-label-primary);cursor:default;background:0 0}.hzyPdq_crumbSeparator{color:var(--dsw-alias-label-caption);flex:none;display:inline-flex}";
		...
		var MenuView_module_css_default = {
			"active": "hzyPdq_active",
			"crumb": "hzyPdq_crumb",
			"crumbCurrent": "hzyPdq_crumbCurrent",
			"crumbSeparator": "hzyPdq_crumbSeparator",
			"crumbs": "hzyPdq_crumbs",
			"drill": "hzyPdq_drill",
			"drillHint": "hzyPdq_drillHint",
			"drillHintText": "hzyPdq_drillHintText",
			"dsh-menu-skeleton": "hzyPdq_dsh-menu-skeleton",
			"groupTitle": "hzyPdq_groupTitle",
			"item": "hzyPdq_item",
			"itemAlias": "hzyPdq_itemAlias",
			"itemDescription": "hzyPdq_itemDescription",
			"itemIcon": "hzyPdq_itemIcon",
			"itemName": "hzyPdq_itemName",
			"menu": "hzyPdq_menu",
			"sectionTitle": "hzyPdq_sectionTitle",
			"skeletonBar": "hzyPdq_skeletonBar",
			"skeletonRow": "hzyPdq_skeletonRow",
			"trailing": "hzyPdq_trailing",
			"viewport": "hzyPdq_viewport"
		};
		//#endregion
