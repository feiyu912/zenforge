window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-attachment/src/AttachmentRail.module.css.mjs
		const css$5 = ".VQCBVq_root{min-width:0;position:relative}.VQCBVq_rail{scrollbar-width:none;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);align-items:stretch;gap:10px;display:flex;overflow:auto hidden}.VQCBVq_rail::-webkit-scrollbar{display:none}.VQCBVq_item{flex:none;height:64px}.VQCBVq_thumbnail{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;width:64px;height:64px;padding:0;overflow:hidden}.VQCBVq_thumbnail img{object-fit:cover;width:100%;height:100%;display:block}.VQCBVq_remove{z-index:1;corner-shape:round;background:var(--dsw-alias-button-contrast-fill);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted);cursor:pointer;opacity:0;border:none;border-radius:50%;place-items:center;padding:0;transition:opacity .2s ease-in-out;display:grid;position:absolute;top:4px;right:4px}.VQCBVq_item:hover .VQCBVq_remove,.VQCBVq_remove:focus-visible{opacity:1}@media (pointer:coarse){.VQCBVq_remove{opacity:1}}@media (prefers-reduced-motion:reduce){.VQCBVq_remove{transition:none}}.VQCBVq_arrow{z-index:2;--dsw-elevation-stroke-color:var(--dsw-alias-border-l2-darkmode-thin);corner-shape:round;background:var(--dsw-specific-input-major);width:24px;height:24px;color:var(--dsw-alias-label-secondary);box-shadow:var(--dsw-elevation-panel);cursor:pointer;border:0;border-radius:999px;place-items:center;padding:0;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.VQCBVq_arrow:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.VQCBVq_arrowLeft{left:4px}.VQCBVq_arrowRight{right:4px}";
		...
		var AttachmentRail_module_css_default = {
			"arrow": "VQCBVq_arrow",
			"arrowLeft": "VQCBVq_arrowLeft",
			"arrowRight": "VQCBVq_arrowRight",
			"item": "VQCBVq_item",
			"rail": "VQCBVq_rail",
			"remove": "VQCBVq_remove",
			"root": "VQCBVq_root",
			"thumbnail": "VQCBVq_thumbnail"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-attachment/src/DropOverlay.module.css.mjs
		const css$4 = ".hnGiyq_mask{z-index:1000;pointer-events:none;background-color:var(--dsw-alias-bg-mask-drop);backdrop-filter:blur(10px);justify-content:center;align-items:center;animation:.16s ease-out hnGiyq_fade-in;display:flex;position:fixed;inset:0}@keyframes hnGiyq_fade-in{0%{opacity:0}to{opacity:1}}@media (prefers-reduced-motion:reduce){.hnGiyq_mask{animation:none}}.hnGiyq_wrap{color:var(--dsw-alias-label-primary);text-align:center;flex-direction:column;align-items:center;margin-top:-3%;padding:0 40px;display:flex}.hnGiyq_illustration{width:115px;height:84px}.hnGiyq_title{font:var(--dsw-font-l-20);margin-top:16px}.hnGiyq_desc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;margin-top:16px}";
		...
		var DropOverlay_module_css_default = {
			"desc": "hnGiyq_desc",
			"fade-in": "hnGiyq_fade-in",
			"illustration": "hnGiyq_illustration",
			"mask": "hnGiyq_mask",
			"title": "hnGiyq_title",
			"wrap": "hnGiyq_wrap"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-attachment/src/FileCard.module.css.mjs
		const css$3 = ".fzmEMa_card{border:.5px solid var(--dsw-alias-border-l2,#0000001f);background:var(--dsw-specific-input-major,transparent);box-sizing:border-box;text-align:left;border-radius:16px;align-items:center;gap:10px;width:240px;height:64px;padding:0 12px;display:inline-flex;position:relative}.fzmEMa_failed{border-color:var(--dsw-alias-state-error-primary,#d54941)}.fzmEMa_icon{flex:none;justify-content:center;align-items:center;width:28px;height:28px;display:inline-flex}.fzmEMa_spinner{corner-shape:round;border:2px solid;border-top-color:#0000;border-radius:50%;width:20px;height:20px;animation:.8s linear infinite fzmEMa_file-card-spin}@keyframes fzmEMa_file-card-spin{to{transform:rotate(360deg)}}.fzmEMa_body{flex-direction:column;flex:1;min-width:0;padding:8px 0;display:flex}.fzmEMa_retry{color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;padding:0}.fzmEMa_name{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px;overflow:hidden}.fzmEMa_meta{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-tertiary,#00000073);font-size:12px;line-height:15px;overflow:hidden}.fzmEMa_metaFailed{color:var(--dsw-alias-state-error-primary,#d54941)}.fzmEMa_remove{corner-shape:round;background:var(--dsw-alias-button-contrast-fill,#000000b8);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted,#fff);opacity:0;cursor:pointer;border:none;border-radius:50%;justify-content:center;align-items:center;padding:0;transition:opacity .2s ease-in-out;display:inline-flex;position:absolute;top:6px;right:6px}.fzmEMa_card:hover .fzmEMa_remove,.fzmEMa_remove:focus-visible{opacity:1}@media (pointer:coarse){.fzmEMa_remove{opacity:1}}@media (prefers-reduced-motion:reduce){.fzmEMa_remove{transition:none}}.fzmEMa_card:hover .fzmEMa_name,.fzmEMa_card:focus-within .fzmEMa_name{padding-right:18px}.fzmEMa_removeFailed{background:var(--dsw-alias-state-error-primary,#d54941);color:#fff;opacity:1}.fzmEMa_progressTrack{background:var(--dsw-alias-fill-tertiary,#00000014);border-radius:1px;height:2px;position:absolute;bottom:5px;left:12px;right:12px;overflow:hidden}.fzmEMa_progressBar{border-radius:inherit;background:var(--dsw-alias-brand-primary,#4d6bfe);width:35%;height:100%;animation:1.2s ease-in-out infinite alternate fzmEMa_file-card-progress;display:block}.fzmEMa_progressBar[style]{animation:none}@keyframes fzmEMa_file-card-progress{0%{transform:translate(-70%)}to{transform:translate(220%)}}@media (pointer:coarse){.fzmEMa_remove{opacity:1}}";
		...
		var FileCard_module_css_default = {
			"body": "fzmEMa_body",
			"card": "fzmEMa_card",
			"failed": "fzmEMa_failed",
			"file-card-progress": "fzmEMa_file-card-progress",
			"file-card-spin": "fzmEMa_file-card-spin",
			"icon": "fzmEMa_icon",
			"meta": "fzmEMa_meta",
			"metaFailed": "fzmEMa_metaFailed",
			"name": "fzmEMa_name",
			"progressBar": "fzmEMa_progressBar",
			"progressTrack": "fzmEMa_progressTrack",
			"remove": "fzmEMa_remove",
			"removeFailed": "fzmEMa_removeFailed",
			"retry": "fzmEMa_retry",
			"spinner": "fzmEMa_spinner"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-attachment/src/ImageLightbox.module.css.mjs
		const css$2 = ".S3BORW_backdrop{z-index:1000;place-items:center;padding:40px;display:grid;position:fixed;inset:0}.S3BORW_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.S3BORW_image{object-fit:contain;background:var(--dsw-specific-input-major);max-width:min(100%,1600px);max-height:calc(100vh - 80px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;position:relative}.S3BORW_close{z-index:1;border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);corner-shape:round;background:var(--dsw-specific-input-major);width:36px;height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;place-items:center;display:grid;position:fixed;top:20px;right:20px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-attachment/src/client/ComposerAttachments.module.css.mjs
		const css$1 = "._1dfu-q_rail{min-width:0;margin-bottom:-6px;padding:2px 10px 0}._1dfu-q_imageItem{width:64px;height:64px;position:relative}._1dfu-q_thumbnail{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;width:64px;height:64px;padding:0;overflow:hidden}._1dfu-q_thumbnail img{object-fit:cover;width:100%;height:100%;display:block}._1dfu-q_remove{z-index:1;corner-shape:round;background:var(--dsw-alias-button-contrast-fill);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted);cursor:pointer;opacity:0;border:none;border-radius:50%;place-items:center;padding:0;transition:opacity .2s ease-in-out;display:grid;position:absolute;top:4px;right:4px}._1dfu-q_imageItem:hover ._1dfu-q_remove,._1dfu-q_remove:focus-visible{opacity:1}@media (pointer:coarse){._1dfu-q_remove{opacity:1}}@media (prefers-reduced-motion:reduce){._1dfu-q_remove{transition:none}}";
		...
		var ComposerAttachments_module_css_default = {
			"imageItem": "_1dfu-q_imageItem",
			"rail": "_1dfu-q_rail",
			"remove": "_1dfu-q_remove",
			"thumbnail": "_1dfu-q_thumbnail"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-attachment/src/MessageImage.module.css.mjs
		const css = ".M0ap4a_gallery{flex-wrap:wrap;gap:10px;max-width:100%;display:flex}.M0ap4a_gallery[data-align=end]{justify-content:flex-end;align-self:flex-end}.M0ap4a_gallery[data-align=start]{justify-content:flex-start;align-self:flex-start}.M0ap4a_frame{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;flex:none;place-items:center;min-width:44px;min-height:44px;padding:0;display:grid;overflow:hidden}.M0ap4a_frame[data-variant=tile]{width:64px;min-width:64px;height:64px;min-height:64px}.M0ap4a_frame img{object-fit:cover;width:100%;height:100%;display:block}.M0ap4a_loading,.M0ap4a_error{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.M0ap4a_error{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover-danger);cursor:pointer;border-radius:10px;max-width:240px;padding:10px 12px}.M0ap4a_error[data-variant=tile]{border-radius:16px;width:64px;height:64px;padding:4px;overflow:hidden}.M0ap4a_frame[data-variant=thumbnail],.M0ap4a_error[data-variant=thumbnail]{box-sizing:border-box;border-radius:8px;place-items:center;width:48px;min-width:48px;height:48px;min-height:48px;padding:2px;display:grid;overflow:hidden}.M0ap4a_frame[data-variant=thumbnail] img{object-fit:contain}.M0ap4a_spinner{animation:.9s linear infinite M0ap4a_spinner-rotate}@keyframes M0ap4a_spinner-rotate{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.M0ap4a_spinner{animation:none}}.M0ap4a_frame:focus-visible,.M0ap4a_error:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}";
		...
		var MessageImage_module_css_default = {
			"error": "M0ap4a_error",
			"frame": "M0ap4a_frame",
			"gallery": "M0ap4a_gallery",
			"loading": "M0ap4a_loading",
			"spinner": "M0ap4a_spinner",
			"spinner-rotate": "M0ap4a_spinner-rotate"
		};
		//#endregion
		...
		function MessageImage({ image, load, variant, labels }) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("button", {
				...
				children: src === null ? (0, react_jsx_runtime.jsx)("span", {
					...
					children: loadingThumbnail ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLoadingOutline16, { className: MessageImage_module_css_default.spinner }) : labels.loading
				}) : (0, react_jsx_runtime.jsx)("img", {
					src,
					alt: label,
