window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-schedule/src/client/ScheduleCatalogAction.module.css.mjs
		const css = "._6KYsnG_root{position:relative}._6KYsnG_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:4px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}._6KYsnG_trigger:hover,._6KYsnG_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}._6KYsnG_trigger svg{flex:none}._6KYsnG_trigger>svg:last-child{transition:transform .12s}._6KYsnG_triggerOpen{transform:rotate(180deg)}._6KYsnG_count{margin-left:2px}._6KYsnG_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:336px;max-width:min(336px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;gap:2px;margin:0;padding:4px;list-style:none;display:flex;position:fixed;overflow:auto}._6KYsnG_row{box-sizing:border-box;width:100%;min-height:54px;color:var(--dsw-alias-label-primary);border-radius:8px;flex-direction:column;flex-shrink:0;gap:3px;padding:8px 10px;display:flex}._6KYsnG_rowOverdue{background:var(--dsw-alias-state-warn-tertiary)}._6KYsnG_status{color:var(--dsw-alias-label-tertiary);align-items:center;gap:5px;font-size:11px;line-height:16px;display:inline-flex}._6KYsnG_statusDot{corner-shape:round;background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:8px;height:8px}._6KYsnG_rowOverdue ._6KYsnG_status{color:var(--dsw-alias-state-warn-label)}._6KYsnG_rowOverdue ._6KYsnG_statusDot{background:var(--dsw-alias-state-warn-primary)}._6KYsnG_prompt{overflow-wrap:anywhere;white-space:normal;font-size:13px;line-height:18px}._6KYsnG_metadata{min-width:0;color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:center;gap:5px;font-size:11px;line-height:16px;display:flex}._6KYsnG_relativeOverdue{color:var(--dsw-alias-state-warn-label)}";
		...
		var ScheduleCatalogAction_module_css_default = {
			"count": "_6KYsnG_count",
			"menu": "_6KYsnG_menu",
			"metadata": "_6KYsnG_metadata",
			"prompt": "_6KYsnG_prompt",
			"relativeOverdue": "_6KYsnG_relativeOverdue",
			"root": "_6KYsnG_root",
			"row": "_6KYsnG_row",
			"rowOverdue": "_6KYsnG_rowOverdue",
			"status": "_6KYsnG_status",
			"statusDot": "_6KYsnG_statusDot",
			"trigger": "_6KYsnG_trigger",
			"triggerOpen": "_6KYsnG_triggerOpen"
		};
		//#endregion
