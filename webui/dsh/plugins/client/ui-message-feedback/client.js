window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-message-feedback/src/client/FeedbackDialog.module.css.mjs
		const css$1 = ".MpghYq_dialog.MpghYq_dialog{border-radius:18px;gap:38px;width:min(488px,100%)}.MpghYq_categories{flex-wrap:wrap;gap:8px;margin-top:-14px;display:flex}.MpghYq_chip{border:.5px solid var(--dsw-alias-border-l4);corner-shape:round;height:28px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;background:0 0;border-radius:14px;padding:0 12px;font-size:13px;line-height:18px;transition:background-color .12s,border-color .12s,color .12s}.MpghYq_chip:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.MpghYq_chip:disabled{cursor:default;opacity:.4}.MpghYq_chip:focus-visible{outline:2px solid var(--dsw-alias-button-primary-fill);outline-offset:2px}.MpghYq_chipActive,.MpghYq_chipActive:hover:not(:disabled){border-color:var(--dsw-alias-button-primary-fill);background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground)}.MpghYq_detail{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-1);width:100%;min-height:116px;max-height:280px;color:var(--dsw-alias-label-primary);font:inherit;field-sizing:content;resize:none;border-radius:16px;margin-top:18px;padding:12px 14px;font-size:14px;line-height:22px;transition:border-color .12s,box-shadow .12s;display:block}.MpghYq_detail::placeholder{color:var(--dsw-alias-label-caption)}.MpghYq_detail:focus{border-color:var(--dsw-alias-border-l3);box-shadow:0 0 0 1px var(--dsw-alias-border-l3);outline:none}.MpghYq_submit{border-radius:18px;width:100%;height:44px;font-size:14px;font-weight:500}.MpghYq_toastIcon{border:1.5px solid var(--dsw-alias-state-success-primary);corner-shape:round;width:18px;height:18px;color:var(--dsw-alias-state-success-primary);border-radius:50%;place-items:center;display:grid}@media (prefers-reduced-motion:reduce){.MpghYq_chip,.MpghYq_detail{transition:none}}";
		...
		var FeedbackDialog_module_css_default = {
			"categories": "MpghYq_categories",
			"chip": "MpghYq_chip",
			"chipActive": "MpghYq_chipActive",
			"detail": "MpghYq_detail",
			"dialog": "MpghYq_dialog",
			"submit": "MpghYq_submit",
			"toastIcon": "MpghYq_toastIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-message-feedback/src/client/MessageFeedbackActions.module.css.mjs
		const css = ".AHKHKq_action{width:calc(28px + var(--dsh-content-font-delta,0px));height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.AHKHKq_action svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px))}.AHKHKq_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.AHKHKq_action:disabled{cursor:default;opacity:.4}.AHKHKq_action[data-active]{color:var(--dsw-alias-label-tertiary)}.AHKHKq_failure{color:var(--dsw-alias-label-tertiary);padding-left:4px;font-size:13px;line-height:20px}";
		...
		var MessageFeedbackActions_module_css_default = {
			"action": "AHKHKq_action",
			"failure": "AHKHKq_failure"
		};
		//#endregion
