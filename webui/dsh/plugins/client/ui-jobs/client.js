window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-jobs/src/client/JobListAction.module.css.mjs
		const css = "._81jXq_root{position:relative}._81jXq_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}._81jXq_trigger:hover,._81jXq_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}._81jXq_trigger svg{transition:transform .12s}._81jXq_triggerOpen{transform:rotate(180deg)}._81jXq_triggerDot{flex:none}._81jXq_count{margin:0 5px}._81jXq_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}._81jXq_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}._81jXq_rowSettled{color:var(--dsw-alias-label-tertiary)}._81jXq_rowDot{flex:none}._81jXq_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}._81jXq_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}._81jXq_status,._81jXq_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}._81jXq_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}._81jXq_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"count": "_81jXq_count",
			"duration": "_81jXq_duration",
			"kind": "_81jXq_kind",
			"label": "_81jXq_label",
			"menu": "_81jXq_menu",
			"root": "_81jXq_root",
			"row": "_81jXq_row",
			"rowDot": "_81jXq_rowDot",
			"rowSettled": "_81jXq_rowSettled",
			"status": "_81jXq_status",
			"trigger": "_81jXq_trigger",
			"triggerDot": "_81jXq_triggerDot",
			"triggerOpen": "_81jXq_triggerOpen"
		};
		//#endregion
