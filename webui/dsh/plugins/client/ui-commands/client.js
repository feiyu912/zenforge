window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-commands/src/client/PopupSelectView.module.css.mjs
		const css = "._2cPw5G_card{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);min-width:min(220px,100%);max-width:100%;max-height:320px;box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;outline:none;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;overflow:hidden}._2cPw5G_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}._2cPw5G_row{cursor:pointer;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;display:flex}._2cPw5G_rowActive{background:var(--dsw-alias-interactive-bg-hover)}._2cPw5G_label{flex:0 auto;align-items:baseline;gap:4px;min-width:0;display:flex}._2cPw5G_labelText{white-space:nowrap;text-overflow:ellipsis;min-width:0;overflow:hidden}._2cPw5G_badge{color:var(--dsw-alias-label-tertiary);letter-spacing:.2px;flex:none;align-self:flex-start;margin-top:-1px;font-size:8px;font-weight:600;line-height:10px}._2cPw5G_detail{min-width:0;color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;flex:1;font-size:12px;overflow:hidden}._2cPw5G_check{color:var(--dsw-alias-label-primary);flex:none;margin-left:auto;display:inline-flex}._2cPw5G_status{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:13px}._2cPw5G_search{border:.5px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-primary);background:0 0;border-radius:8px;outline:none;margin:2px 2px 4px;padding:6px 8px;font-size:13px}._2cPw5G_error{color:var(--dsw-alias-state-error-primary);align-items:center;gap:8px;padding:6px 8px;font-size:12px;display:flex}._2cPw5G_errorText{text-overflow:ellipsis;flex:1;overflow:hidden}._2cPw5G_retry{border:.5px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:6px;padding:2px 8px;font-size:12px}";
		...
		var PopupSelectView_module_css_default = {
			...
			"card": "_2cPw5G_card",
			"check": "_2cPw5G_check",
			"detail": "_2cPw5G_detail",
			"error": "_2cPw5G_error",
			"errorText": "_2cPw5G_errorText",
			"label": "_2cPw5G_label",
			"labelText": "_2cPw5G_labelText",
			"retry": "_2cPw5G_retry",
			"row": "_2cPw5G_row",
			"rowActive": "_2cPw5G_rowActive",
			"search": "_2cPw5G_search",
			"status": "_2cPw5G_status",
			"viewport": "_2cPw5G_viewport"
		};
		//#endregion
