window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-tool/src/client/tool/components/AskQuestionCard.module.css.mjs
		const css$3 = ".IXQinG_card{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:16px;max-height:360px;margin:4px 0 4px 4px;padding:16px 20px;display:flex;overflow-y:auto}.IXQinG_item{flex-direction:column;gap:2px;min-width:0;display:flex}.IXQinG_question,.IXQinG_answer{white-space:pre-wrap;overflow-wrap:anywhere;font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));margin:0}.IXQinG_question{color:var(--dsw-alias-label-tertiary)}.IXQinG_answer{color:var(--dsw-alias-label-primary)}.IXQinG_answerLine{display:block}.IXQinG_skipped{color:var(--dsw-alias-label-tertiary)}.IXQinG_verdict{color:var(--dsw-alias-label-primary);font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));margin:0}.IXQinG_questionList{flex-direction:column;gap:8px;margin:0;padding-left:20px;display:flex}.IXQinG_unansweredQuestion{color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;overflow-wrap:anywhere;font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}";
		...
		var AskQuestionCard_module_css_default = {
			"answer": "IXQinG_answer",
			"answerLine": "IXQinG_answerLine",
			"card": "IXQinG_card",
			"item": "IXQinG_item",
			"question": "IXQinG_question",
			"questionList": "IXQinG_questionList",
			"skipped": "IXQinG_skipped",
			"unansweredQuestion": "IXQinG_unansweredQuestion",
			"verdict": "IXQinG_verdict"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$2 = ".cNz2Aq_root{flex-direction:column;display:flex}.cNz2Aq_row{position:relative;overflow:hidden}.cNz2Aq_root[data-state=running] .cNz2Aq_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite cNz2Aq_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes cNz2Aq_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.cNz2Aq_leading{flex-shrink:0}.cNz2Aq_root[data-tool^=cordis_] .cNz2Aq_leading,.cNz2Aq_root[data-tool^=cordis_] .cNz2Aq_title{color:var(--dsw-alias-state-business-primary)}.cNz2Aq_root[data-tool^=cordis_] .cNz2Aq_title{font-weight:500}.cNz2Aq_root[data-tool^=cordis_] .cNz2Aq_sep{background:var(--dsw-alias-state-business-primary)}.cNz2Aq_chevron{color:var(--dsw-alias-label-secondary)}.cNz2Aq_title{font-weight:400}.cNz2Aq_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.cNz2Aq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.cNz2Aq_summarySuffix{white-space:nowrap;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px}.cNz2Aq_diffStat{font-family:var(--ds-font-family-code);font-size:calc(var(--dsh-content-font-size-secondary,13px) - 2px);color:var(--dsw-alias-label-caption);margin-left:10px;transform:translateY(.5px)}.cNz2Aq_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);text-decoration:underline dotted;text-decoration-color:var(--dsw-alias-label-tertiary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:0 auto;margin:0;padding:0;text-decoration-thickness:1px;overflow:hidden}.cNz2Aq_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.cNz2Aq_errorSummary{color:var(--dsw-alias-state-error-primary)}.cNz2Aq_bodyWrap{flex-direction:column;display:flex}.cNz2Aq_inspectButton{border:.5px solid var(--dsw-alias-border-l3);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.cNz2Aq_root:hover .cNz2Aq_inspectButton,.cNz2Aq_inspectButton:focus-visible{opacity:1}.cNz2Aq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.cNz2Aq_bodyScroll{max-height:260px;overflow-y:auto}.cNz2Aq_ioCard{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.cNz2Aq_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.cNz2Aq_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.cNz2Aq_ioSection::-webkit-scrollbar-track{margin:6px 0}.cNz2Aq_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.cNz2Aq_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:.5px}.cNz2Aq_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.cNz2Aq_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.cNz2Aq_codeBody,.cNz2Aq_terminalBody,.cNz2Aq_diffBody,.cNz2Aq_readBody,.cNz2Aq_imageBody,.cNz2Aq_searchBody,.cNz2Aq_webBody{margin:4px 0 4px 4px}.cNz2Aq_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.cNz2Aq_imageLabel{overflow-wrap:anywhere;font:var(--dsw-font-sm-13);color:var(--dsw-alias-label-secondary);margin-bottom:4px}.cNz2Aq_imageMeta{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary)}.cNz2Aq_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.cNz2Aq_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:.5px solid var(--dsw-alias-border-l1)}.cNz2Aq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"bodyScroll": "cNz2Aq_bodyScroll",
			"bodyWrap": "cNz2Aq_bodyWrap",
			"chevron": "cNz2Aq_chevron",
			"codeBody": "cNz2Aq_codeBody",
			"diffBody": "cNz2Aq_diffBody",
			"diffStat": "cNz2Aq_diffStat",
			"dsh-tool-row-sweep": "cNz2Aq_dsh-tool-row-sweep",
			"errorSummary": "cNz2Aq_errorSummary",
			"fileLink": "cNz2Aq_fileLink",
			"imageBody": "cNz2Aq_imageBody",
			"imageLabel": "cNz2Aq_imageLabel",
			"imageMeta": "cNz2Aq_imageMeta",
			"inspectButton": "cNz2Aq_inspectButton",
			"ioCard": "cNz2Aq_ioCard",
			"ioDivider": "cNz2Aq_ioDivider",
			"ioLabel": "cNz2Aq_ioLabel",
			"ioSection": "cNz2Aq_ioSection",
			"ioText": "cNz2Aq_ioText",
			"leading": "cNz2Aq_leading",
			"readBody": "cNz2Aq_readBody",
			"root": "cNz2Aq_root",
			"row": "cNz2Aq_row",
			"searchBody": "cNz2Aq_searchBody",
			"searchRecovery": "cNz2Aq_searchRecovery",
			"sep": "cNz2Aq_sep",
			"summary": "cNz2Aq_summary",
			"summarySuffix": "cNz2Aq_summarySuffix",
			"terminalBody": "cNz2Aq_terminalBody",
			"title": "cNz2Aq_title",
			"visuallyHidden": "cNz2Aq_visuallyHidden",
			"webBody": "cNz2Aq_webBody"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$1 = ".X8eErq_callRow{border-radius:6px}.X8eErq_subCalls{border-left:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "X8eErq_callRow",
			"subCalls": "X8eErq_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".gflTTW_card{flex-direction:column;display:flex}.gflTTW_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:.5px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.gflTTW_ioCard{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.gflTTW_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.gflTTW_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.gflTTW_ioSection::-webkit-scrollbar-track{margin:6px 0}.gflTTW_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.gflTTW_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:.5px}.gflTTW_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.gflTTW_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.gflTTW_root[data-expandable]{cursor:pointer}.gflTTW_root{height:calc(24px + var(--dsh-content-font-delta,0px));align-items:center;min-width:0;display:flex;position:relative;overflow:hidden}.gflTTW_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite gflTTW_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes gflTTW_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.gflTTW_leading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.gflTTW_leading svg:not([data-state]){width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.gflTTW_chevron{color:var(--dsw-alias-label-secondary)}.gflTTW_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.gflTTW_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.gflTTW_root:hover .gflTTW_iconIdle{opacity:0}.gflTTW_root:hover .gflTTW_chevronHover{opacity:1}.gflTTW_title{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none}.gflTTW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.gflTTW_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.gflTTW_errorSummary{color:var(--dsw-alias-state-error-primary)}.gflTTW_bodyWrap{flex-direction:column;display:flex}.gflTTW_inspectButton{border:.5px solid var(--dsw-alias-border-l4);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.gflTTW_card:hover .gflTTW_inspectButton,.gflTTW_inspectButton:focus-visible{opacity:1}.gflTTW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.gflTTW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"bodyWrap": "gflTTW_bodyWrap",
			"card": "gflTTW_card",
			"chevron": "gflTTW_chevron",
			"chevronHover": "gflTTW_chevronHover",
			"dsh-bash-row-sweep": "gflTTW_dsh-bash-row-sweep",
			"errorSummary": "gflTTW_errorSummary",
			"iconIdle": "gflTTW_iconIdle",
			"inspectButton": "gflTTW_inspectButton",
			"ioCard": "gflTTW_ioCard",
			"ioDivider": "gflTTW_ioDivider",
			"ioLabel": "gflTTW_ioLabel",
			"ioSection": "gflTTW_ioSection",
			"ioText": "gflTTW_ioText",
			"leading": "gflTTW_leading",
			"root": "gflTTW_root",
			"sep": "gflTTW_sep",
			"summary": "gflTTW_summary",
			"terminal": "gflTTW_terminal",
			"title": "gflTTW_title",
			"visuallyHidden": "gflTTW_visuallyHidden"
		};
		//#endregion
