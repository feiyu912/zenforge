window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-settings-plugin-inventory/src/client/PluginInventorySettingsTab.module.css.mjs
		const css = ".Ty6D0W_section{width:100%;max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:14px;display:flex}.Ty6D0W_catalogHeading h3,.Ty6D0W_status,.Ty6D0W_failure p{margin:0}.Ty6D0W_status,.Ty6D0W_failure{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:20px}.Ty6D0W_failure{color:var(--dsw-alias-state-error-primary);align-items:center;gap:10px;display:flex}.Ty6D0W_failure button{border:.5px solid var(--dsw-alias-border-l3);color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;background:0 0;border-radius:6px;padding:4px 10px}.Ty6D0W_catalog{flex-direction:column;gap:12px;display:flex}.Ty6D0W_search{width:100%;color:var(--dsw-alias-label-tertiary);align-items:center;display:flex;position:relative}.Ty6D0W_search>svg{pointer-events:none;position:absolute;left:12px}.Ty6D0W_search input{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-1);width:100%;height:36px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:10px;outline:none;padding:0 34px 0 36px;font-size:13px}.Ty6D0W_search input::placeholder{color:var(--dsw-alias-label-tertiary)}.Ty6D0W_search input:focus-visible{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}.Ty6D0W_catalogHeading{align-items:baseline;gap:7px;padding:0 2px;display:flex}.Ty6D0W_catalogHeading h3{font-size:13px;font-weight:600;line-height:20px}.Ty6D0W_catalogHeading span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;line-height:18px}.Ty6D0W_cards{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;margin:0;padding:0;list-style:none;display:grid}.Ty6D0W_card{min-width:0;box-shadow:var(--dsw-elevation-stroke);background:var(--dsw-alias-bg-layer-3);border:0;border-radius:14px;overflow:hidden}.Ty6D0W_card[data-open=true]{--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);box-shadow:var(--dsw-elevation-panel)}.Ty6D0W_cardContent{box-sizing:border-box;width:100%;min-height:52px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex-direction:column;align-items:stretch;padding:12px 14px;display:flex}.Ty6D0W_cardContent:hover,.Ty6D0W_card[data-open=true]>.Ty6D0W_cardContent{background:var(--dsw-alias-interactive-bg-hover)}.Ty6D0W_cardContent:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.Ty6D0W_cardMainRow{justify-content:space-between;align-items:center;gap:12px;min-width:0;display:flex}.Ty6D0W_cardTitle,.Ty6D0W_cardIdentity{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Ty6D0W_cardTitle{flex:1;min-width:0;font-size:14px;font-weight:600;line-height:20px}.Ty6D0W_cardIdentity{width:100%;color:var(--dsw-alias-label-tertiary);font-family:var(--ds-font-family-code);font-size:11px;line-height:16px;display:block}.Ty6D0W_cardTrailing{color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;gap:7px;display:inline-flex}.Ty6D0W_phaseDot{flex:none;display:inline-flex}.Ty6D0W_group{flex-direction:column;gap:10px;display:flex}.Ty6D0W_groupTitleRow{align-items:center;gap:8px;min-height:32px;display:flex}.Ty6D0W_group+.Ty6D0W_group{border-top:.5px solid var(--dsw-alias-border-l2);padding-top:14px}.Ty6D0W_headerEnd{margin-left:auto}.Ty6D0W_groupToggle{color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex:none;align-items:center;gap:8px;padding:0;display:flex}.Ty6D0W_groupToggle:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Ty6D0W_groupToggle>.Ty6D0W_chevron{transform:rotate(-90deg)}.Ty6D0W_groupToggle[aria-expanded=true]>.Ty6D0W_chevron{transform:none}.Ty6D0W_groupTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.Ty6D0W_groupSub{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex-wrap:wrap;gap:4px 8px;margin:-6px 0 0 20px;font-size:12px;line-height:18px;display:flex}.Ty6D0W_failedCount{color:var(--dsw-alias-state-error-primary)}.Ty6D0W_switcher{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);height:36px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border:none;border-radius:18px;flex:none;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.Ty6D0W_switcher:hover{background:var(--dsw-alias-interactive-bg-hover)}.Ty6D0W_switcher:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Ty6D0W_switcher>.Ty6D0W_chevron{flex:none}.Ty6D0W_switcherLabel{text-overflow:ellipsis;max-width:240px;overflow:hidden}.Ty6D0W_groupBody{flex-direction:column;gap:10px;display:flex}.Ty6D0W_brokenNote{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 8%, transparent);color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;white-space:pre-line;border-radius:8px;margin:0;padding:8px 10px;font-size:12.5px;line-height:18px}.Ty6D0W_hint{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:baseline;gap:4px 8px;margin:0;font-size:12.5px;line-height:18px;display:flex}.Ty6D0W_jumpLink{color:var(--dsw-alias-state-business-primary);font:inherit;cursor:pointer;background:0 0;border:0;padding:0;font-size:12.5px}.Ty6D0W_enabledIn{flex-wrap:wrap;align-items:baseline;gap:4px 10px;display:flex}.Ty6D0W_card[data-failed=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 45%, transparent)}.Ty6D0W_chevron{color:var(--dsw-alias-label-tertiary);flex:none}.Ty6D0W_card[data-open=true] .Ty6D0W_chevron{transform:rotate(180deg)}.Ty6D0W_cardDetails{border-top:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);padding:10px 14px 12px}.Ty6D0W_entryValue{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code);font-size:12px;line-height:18px;display:block}.Ty6D0W_details{grid-template-columns:76px minmax(0,1fr);gap:6px 10px;margin:8px 0 0;display:grid}.Ty6D0W_details div{display:contents}.Ty6D0W_details dt{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.Ty6D0W_details dd{overflow-wrap:anywhere;min-width:0;color:var(--dsw-alias-label-secondary);margin:0;font-size:12px;line-height:17px}.Ty6D0W_visuallyHidden{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:no-preference){.Ty6D0W_chevron{transition:transform .14s var(--ds-ease-in-out)}}@media (width<=680px){.Ty6D0W_cards{grid-template-columns:minmax(0,1fr)}}";
		...
		var PluginInventorySettingsTab_module_css_default = {
			"brokenNote": "Ty6D0W_brokenNote",
			"card": "Ty6D0W_card",
			"cardContent": "Ty6D0W_cardContent",
			"cardDetails": "Ty6D0W_cardDetails",
			"cardIdentity": "Ty6D0W_cardIdentity",
			"cardMainRow": "Ty6D0W_cardMainRow",
			"cardTitle": "Ty6D0W_cardTitle",
			"cardTrailing": "Ty6D0W_cardTrailing",
			"cards": "Ty6D0W_cards",
			"catalog": "Ty6D0W_catalog",
			"catalogHeading": "Ty6D0W_catalogHeading",
			"chevron": "Ty6D0W_chevron",
			"details": "Ty6D0W_details",
			"enabledIn": "Ty6D0W_enabledIn",
			"entryValue": "Ty6D0W_entryValue",
			"failedCount": "Ty6D0W_failedCount",
			"failure": "Ty6D0W_failure",
			"group": "Ty6D0W_group",
			"groupBody": "Ty6D0W_groupBody",
			"groupSub": "Ty6D0W_groupSub",
			"groupTitle": "Ty6D0W_groupTitle",
			"groupTitleRow": "Ty6D0W_groupTitleRow",
			"groupToggle": "Ty6D0W_groupToggle",
			"headerEnd": "Ty6D0W_headerEnd",
			"hint": "Ty6D0W_hint",
			"jumpLink": "Ty6D0W_jumpLink",
			"phaseDot": "Ty6D0W_phaseDot",
			"search": "Ty6D0W_search",
			"section": "Ty6D0W_section",
			"status": "Ty6D0W_status",
			"switcher": "Ty6D0W_switcher",
			"switcherLabel": "Ty6D0W_switcherLabel",
			"visuallyHidden": "Ty6D0W_visuallyHidden"
		};
		//#endregion
		...
		function PluginInventorySettingsTab({ list, presetName, t, useClientSync, retryClient }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					clientSync.syncing ? (0, react_jsx_runtime.jsx)("p", {
						className: PluginInventorySettingsTab_module_css_default.status,
						role: "status",
						children: t("clientSyncing")
					}) : null,
