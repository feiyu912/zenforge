window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-goal/src/client/GoalBar.module.css.mjs
		const css$1 = ".seqX7W_dock{box-sizing:border-box;width:calc(100% - var(--dsh-composer-side-clearance) - var(--dsh-composer-side-clearance) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset));margin:0 auto}.seqX7W_bar{box-sizing:border-box;width:100%;max-width:calc(var(--dsh-composer-card-max-width) - 4 * var(--dsh-composer-dock-inset));border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-specific-tip);border-radius:12px;align-items:center;gap:10px;height:36px;margin:0 auto;padding:4px 5px 4px 12px;display:flex}.seqX7W_goalGlyph{color:var(--dsw-alias-label-tertiary);flex:none;display:inline-flex}.seqX7W_label{color:var(--dsw-alias-label-primary);flex:none;font-size:13px;font-weight:500;line-height:24px}.seqX7W_objective{min-width:0;color:var(--dsw-alias-label-primary-dimmed);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}.seqX7W_error{min-width:0;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:20px;overflow:hidden}.seqX7W_objectiveInput{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-primary);border-radius:6px;outline:none;flex:1;padding:0 8px;font-size:13px;line-height:20px}.seqX7W_objectiveInput:focus{border-color:var(--dsw-alias-state-business-primary)}.seqX7W_objectiveInput::placeholder{color:var(--dsw-alias-label-caption)}.seqX7W_actions{flex:none;align-items:center;gap:10px;display:flex}.seqX7W_iconBtn{corner-shape:round;width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.seqX7W_iconBtn:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.seqX7W_iconBtn:disabled{opacity:.4;cursor:default}";
		...
		var GoalBar_module_css_default = {
			"actions": "seqX7W_actions",
			"bar": "seqX7W_bar",
			"dock": "seqX7W_dock",
			"error": "seqX7W_error",
			"goalGlyph": "seqX7W_goalGlyph",
			"iconBtn": "seqX7W_iconBtn",
			"label": "seqX7W_label",
			"objective": "seqX7W_objective",
			"objectiveInput": "seqX7W_objectiveInput"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-goal/src/client/GoalCommandInputView.module.css.mjs
		const css = "._0MTCva_row{flex-direction:column;align-items:flex-end;gap:6px;display:flex}._0MTCva_stack{min-width:0;max-width:min(calc(var(--dsh-chat-content-width,748px) * .702), 82%);flex-direction:column;align-items:flex-end;display:flex}._0MTCva_bubble{overflow-wrap:anywhere;background:var(--dsw-specific-bubble);max-width:100%;color:var(--dsw-alias-label-primary);font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));white-space:pre-wrap;border-radius:22px;padding:10px 16px}";
