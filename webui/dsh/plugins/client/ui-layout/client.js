window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-layout/src/client/AppFrame.module.css.mjs
		const css = ".NthQxW_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.NthQxW_frame[data-dragging]{transition:none}[data-windows-titlebar] .NthQxW_frame{--dsh-windows-content-radius:16px;box-sizing:border-box;padding-top:var(--dsh-windows-titlebar-height);background:var(--dsw-specific-sidebar-fill);grid-template-rows:minmax(0,1fr)}[data-windows-titlebar] .NthQxW_centerCol{background:var(--dsw-alias-bg-base);border-radius:var(--dsh-windows-content-radius) 0 0 0;corner-shape:round}[data-windows-titlebar] .NthQxW_frame:before{content:\"\";height:var(--dsh-windows-titlebar-height);background:var(--dsw-specific-sidebar-fill);-webkit-app-region:drag;position:absolute;inset:0 0 auto}[data-windows-titlebar] .NthQxW_sidebarCol{border-right:none}[data-windows-titlebar] .NthQxW_handle{top:var(--dsh-windows-titlebar-height)}@media (prefers-reduced-motion:reduce){.NthQxW_frame{transition:none}}.NthQxW_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:.5px solid var(--dsw-alias-border-l3);min-width:0;overflow:hidden}.NthQxW_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}[data-platform=darwin] .NthQxW_frame{background:0 0}[data-platform=darwin] .NthQxW_sidebarCol{background:color-mix(in srgb, var(--dsw-specific-sidebar-fill) 60%, transparent);border-right:none}[data-platform=darwin] .NthQxW_centerCol{background:var(--dsw-alias-bg-base);border-left:.5px solid var(--dsw-alias-border-l3)}[data-platform=darwin] [data-sidebar-collapsed] .NthQxW_centerCol{border-left:none}.NthQxW_handle{cursor:col-resize;z-index:11;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.NthQxW_frame[data-dragging] .NthQxW_handle,.NthQxW_frame[data-rightbar-fullscreen],.NthQxW_frame[data-rightbar-fullscreen] .NthQxW_handle,.NthQxW_frame[data-rightbar-instant],.NthQxW_frame[data-rightbar-instant] .NthQxW_handle{transition:none}@media (prefers-reduced-motion:reduce){.NthQxW_handle{transition:none}}.NthQxW_rightbarCol{min-width:0;position:relative;overflow:visible}.NthQxW_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.NthQxW_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"centerCol": "NthQxW_centerCol",
			"frame": "NthQxW_frame",
			"handle": "NthQxW_handle",
			"overlayLayer": "NthQxW_overlayLayer",
			"rightbarCol": "NthQxW_rightbarCol",
			"sidebarCol": "NthQxW_sidebarCol"
		};
		//#endregion
