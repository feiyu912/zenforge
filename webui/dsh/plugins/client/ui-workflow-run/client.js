window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-workflow-run/src/client/WorkflowRunPanel.module.css.mjs
		const css = ".M5OizG_root{width:100%;min-width:0}.M5OizG_runHeader{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border-radius:8px;align-items:center;gap:6px;width:100%;min-width:0;height:32px;padding:0 8px;display:flex}.M5OizG_runHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.M5OizG_runLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.M5OizG_runTitle{max-width:42%;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);font-weight:510;line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.M5OizG_runSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.M5OizG_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}.M5OizG_phaseHeader{box-sizing:border-box;align-items:center;gap:6px;width:100%;min-width:0;height:32px;display:flex}.M5OizG_phaseHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px;border-radius:4px}.M5OizG_phaseLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.M5OizG_phaseTitle{min-width:0;max-width:42%;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:0 auto;overflow:hidden}.M5OizG_phaseCount{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.M5OizG_phaseStatus{width:calc(132px + var(--dsh-content-font-delta-secondary,0px) * 10);color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.M5OizG_separator{corner-shape:round;background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:2px;height:2px}.M5OizG_phaseList{flex-direction:column;gap:4px;min-width:0;padding:4px 0 0 16px;display:flex}.M5OizG_phase{min-width:0}.M5OizG_members{flex-direction:column;gap:2px;min-width:0;padding:0 0 0 16px;display:flex}.M5OizG_memberRow,.M5OizG_memberButton{width:100%;min-width:0;min-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;background:0 0;border:0;border-radius:4px;align-items:center;gap:12px;padding:0;display:flex}.M5OizG_memberButton{cursor:pointer}.M5OizG_memberButton .M5OizG_memberLabel{color:var(--dsw-alias-link);font-weight:500;text-decoration:none}.M5OizG_memberButton:hover .M5OizG_memberLabel,.M5OizG_memberButton:focus-visible .M5OizG_memberLabel{text-underline-offset:3px;text-decoration:underline dotted}.M5OizG_dotSlot{width:16px;height:calc(24px + var(--dsh-content-font-delta,0px));flex:none;justify-content:center;align-items:center;display:inline-flex;overflow:hidden}.M5OizG_memberButton:focus-visible{outline:none}.M5OizG_memberButton:focus-visible .M5OizG_memberLabelWrap{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.M5OizG_memberLabelWrap{min-width:0;height:calc(24px + var(--dsh-content-font-delta,0px));border-radius:4px;flex:1;align-items:center;padding:0 2px;display:flex;overflow:hidden}.M5OizG_memberLabel{min-width:0;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.M5OizG_memberStatus{width:64px;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.M5OizG_empty{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));padding:0}@media (width<=560px){.M5OizG_phaseList,.M5OizG_members{padding-left:12px}}";
		...
		var WorkflowRunPanel_module_css_default = {
			"dotSlot": "M5OizG_dotSlot",
			"empty": "M5OizG_empty",
			"memberButton": "M5OizG_memberButton",
			"memberLabel": "M5OizG_memberLabel",
			"memberLabelWrap": "M5OizG_memberLabelWrap",
			"memberRow": "M5OizG_memberRow",
			"memberStatus": "M5OizG_memberStatus",
			"members": "M5OizG_members",
			"phase": "M5OizG_phase",
			"phaseCount": "M5OizG_phaseCount",
			"phaseHeader": "M5OizG_phaseHeader",
			"phaseLeading": "M5OizG_phaseLeading",
			"phaseList": "M5OizG_phaseList",
			"phaseStatus": "M5OizG_phaseStatus",
			"phaseTitle": "M5OizG_phaseTitle",
			"root": "M5OizG_root",
			"runHeader": "M5OizG_runHeader",
			"runLeading": "M5OizG_runLeading",
			"runSummary": "M5OizG_runSummary",
			"runTitle": "M5OizG_runTitle",
			"separator": "M5OizG_separator",
			"statusTail": "M5OizG_statusTail"
		};
		//#endregion
