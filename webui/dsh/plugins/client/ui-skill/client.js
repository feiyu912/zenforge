window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-skill/src/client/SkillRow.module.css.mjs
		const css = ".k5yHvG_card{flex-direction:column;display:flex}.k5yHvG_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.k5yHvG_row[data-expandable]{cursor:pointer}.k5yHvG_card[data-state=running] .k5yHvG_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite k5yHvG_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes k5yHvG_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}.k5yHvG_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.k5yHvG_chevron{color:var(--dsw-alias-label-secondary)}.k5yHvG_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.k5yHvG_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.k5yHvG_row:hover .k5yHvG_iconIdle{opacity:0}.k5yHvG_row:hover .k5yHvG_chevronHover{opacity:1}.k5yHvG_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.k5yHvG_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.k5yHvG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.k5yHvG_errorSummary{color:var(--dsw-alias-state-error-primary)}.k5yHvG_bodyWrap{flex-direction:column;display:flex}.k5yHvG_instructionsCard{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}.k5yHvG_instructionsHeader{border-bottom:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}.k5yHvG_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}.k5yHvG_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}.k5yHvG_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.k5yHvG_instructions::-webkit-scrollbar-track{margin:6px 0}.k5yHvG_inspectButton{border:.5px solid var(--dsw-alias-border-l4);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.k5yHvG_card:hover .k5yHvG_inspectButton,.k5yHvG_inspectButton:focus-visible{opacity:1}.k5yHvG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.k5yHvG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.k5yHvG_card[data-state=running] .k5yHvG_row:after{animation:none;display:none}.k5yHvG_iconIdle,.k5yHvG_chevronHover,.k5yHvG_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"bodyWrap": "k5yHvG_bodyWrap",
			"card": "k5yHvG_card",
			"chevron": "k5yHvG_chevron",
			"chevronHover": "k5yHvG_chevronHover",
			"dsh-skill-row-sweep": "k5yHvG_dsh-skill-row-sweep",
			"errorSummary": "k5yHvG_errorSummary",
			"iconIdle": "k5yHvG_iconIdle",
			"inspectButton": "k5yHvG_inspectButton",
			"instructions": "k5yHvG_instructions",
			"instructionsCard": "k5yHvG_instructionsCard",
			"instructionsHeader": "k5yHvG_instructionsHeader",
			"leading": "k5yHvG_leading",
			"row": "k5yHvG_row",
			"separator": "k5yHvG_separator",
			"summary": "k5yHvG_summary",
			"title": "k5yHvG_title",
			"visuallyHidden": "k5yHvG_visuallyHidden"
		};
		//#endregion
