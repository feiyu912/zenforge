window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-sidebar-files/src/client/FilesBody.module.css.mjs
		const css = ".Q8LTgq_root{height:100%;min-height:0;color:var(--dsw-alias-label-primary);font-size:var(--dsh-content-font-size-secondary,13px);flex-direction:column;flex:auto;line-height:1.5;display:flex}.Q8LTgq_header{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l3);flex:none;align-items:center;gap:4px;height:38px;padding:0 6px 0 16px;display:flex}.Q8LTgq_path{white-space:nowrap;flex:auto;justify-content:flex-end;min-width:0;margin-right:12px;font-size:12px;display:flex;overflow:hidden}.Q8LTgq_path[data-files-path-clipped]{mask-image:linear-gradient(90deg,#0000,#000 28px)}.Q8LTgq_pathText{flex:none;margin-right:auto}.Q8LTgq_pathDirectory{color:var(--dsw-alias-label-tertiary)}.Q8LTgq_pathName{color:var(--dsw-alias-label-primary)}.Q8LTgq_body{scrollbar-gutter:stable;flex:auto;min-height:0;margin-right:2px;padding:8px 0 8px 8px;overflow:auto}.Q8LTgq_body::-webkit-scrollbar-track{margin:2px}.Q8LTgq_level{margin:0;padding:0;list-style:none}.Q8LTgq_level .Q8LTgq_level{padding-left:18px}.Q8LTgq_item{margin:0;padding:0}.Q8LTgq_row{width:100%;min-width:0;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:10px;align-items:center;gap:6px;padding:5px 10px;display:flex}.Q8LTgq_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.Q8LTgq_icon{color:var(--dsw-alias-label-tertiary);flex:none}.Q8LTgq_fileIcon{flex:none}.Q8LTgq_name{white-space:nowrap;text-overflow:ellipsis;min-width:0;overflow:hidden}.Q8LTgq_other{color:var(--dsw-alias-label-tertiary);cursor:default}.Q8LTgq_other:hover{background:0 0}.Q8LTgq_note{color:var(--dsw-alias-label-tertiary);margin:0;padding:3px 10px;font-size:12px}.Q8LTgq_status{flex-direction:column;padding:12px 10px;display:flex}.Q8LTgq_statusLine{color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);margin:0;line-height:1.6}.Q8LTgq_tool{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:28px;flex:none;justify-content:center;align-items:center;padding:6px;line-height:1;display:inline-flex}.Q8LTgq_tool svg{width:15px;height:15px}.Q8LTgq_tool:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Q8LTgq_titleIcon{flex:none}";
		...
		var FilesBody_module_css_default = {
			"body": "Q8LTgq_body",
			"fileIcon": "Q8LTgq_fileIcon",
			"header": "Q8LTgq_header",
			"icon": "Q8LTgq_icon",
			"item": "Q8LTgq_item",
			"level": "Q8LTgq_level",
			"name": "Q8LTgq_name",
			...
			"other": "Q8LTgq_other",
			"path": "Q8LTgq_path",
			"pathDirectory": "Q8LTgq_pathDirectory",
			"pathName": "Q8LTgq_pathName",
			"pathText": "Q8LTgq_pathText",
			"root": "Q8LTgq_root",
			"row": "Q8LTgq_row",
			"status": "Q8LTgq_status",
			"statusLine": "Q8LTgq_statusLine",
			"titleIcon": "Q8LTgq_titleIcon",
			"tool": "Q8LTgq_tool"
		};
		//#endregion
