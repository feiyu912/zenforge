window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = ".WG_HTa_root{min-width:0;position:relative}.WG_HTa_trigger{min-width:0;max-width:min(360px,45cqw);height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.WG_HTa_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.WG_HTa_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.WG_HTa_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.WG_HTa_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.WG_HTa_triggerEffort{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-caption);flex-shrink:1000;overflow:hidden}.WG_HTa_triggerIcon{flex:none;display:none}@container (width<=360px){.WG_HTa_triggerIcon{display:block}.WG_HTa_triggerLabel,.WG_HTa_triggerEffort{display:none}}.WG_HTa_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.WG_HTa_chevronOpen{transform:rotate(180deg)}.WG_HTa_menu{z-index:1100;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:max-content;min-width:min(240px,100vw - 32px);max-width:min(420px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-elevation-prominent);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:20px;flex-direction:column;padding:4px;display:flex;position:fixed;overflow:hidden}.WG_HTa_status,.WG_HTa_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.WG_HTa_error,.WG_HTa_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.WG_HTa_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.WG_HTa_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.WG_HTa_groups{min-height:0;overflow-y:auto}.WG_HTa_group+.WG_HTa_group{margin-top:4px}.WG_HTa_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.WG_HTa_option{box-sizing:border-box;width:auto;min-width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.WG_HTa_option:hover:not(:disabled),.WG_HTa_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.WG_HTa_selected{background:0 0}.WG_HTa_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.WG_HTa_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.WG_HTa_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.WG_HTa_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.WG_HTa_cell{box-sizing:border-box;width:auto;min-width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.WG_HTa_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.WG_HTa_cellLabel{white-space:nowrap;flex:none}.WG_HTa_cellValue{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.WG_HTa_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"cell": "WG_HTa_cell",
			"cellChevron": "WG_HTa_cellChevron",
			"cellLabel": "WG_HTa_cellLabel",
			"cellValue": "WG_HTa_cellValue",
			"check": "WG_HTa_check",
			"chevron": "WG_HTa_chevron",
			"chevronOpen": "WG_HTa_chevronOpen",
			"empty": "WG_HTa_empty",
			"error": "WG_HTa_error",
			"group": "WG_HTa_group",
			"groupTitle": "WG_HTa_groupTitle",
			"groups": "WG_HTa_groups",
			"menu": "WG_HTa_menu",
			"modelName": "WG_HTa_modelName",
			"option": "WG_HTa_option",
			"optionCopy": "WG_HTa_optionCopy",
			"retry": "WG_HTa_retry",
			"root": "WG_HTa_root",
			"selected": "WG_HTa_selected",
			"status": "WG_HTa_status",
			"trigger": "WG_HTa_trigger",
			"triggerEffort": "WG_HTa_triggerEffort",
			"triggerIcon": "WG_HTa_triggerIcon",
			"triggerLabel": "WG_HTa_triggerLabel",
			"warning": "WG_HTa_warning"
		};
		//#endregion
