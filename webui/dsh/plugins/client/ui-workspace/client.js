window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".COBsKq_projectRow,.COBsKq_sessionRow{padding:0 8px;cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding-inline-start:calc(8px + var(--dsh-workspace-indent,0px));display:flex}.COBsKq_projectRow:hover,.COBsKq_sessionRow:hover,.COBsKq_sessionRow.COBsKq_selected{background:var(--dsw-alias-interactive-bg-hover)}.COBsKq_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.COBsKq_searchResultRow:hover,.COBsKq_searchResultRow.COBsKq_selected{background:var(--dsw-alias-interactive-bg-hover)}.COBsKq_searchResultHeading{align-items:center;min-width:0;display:flex}.COBsKq_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.COBsKq_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.COBsKq_searchResultWorkspace,.COBsKq_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.COBsKq_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.COBsKq_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.COBsKq_projectRow{box-sizing:border-box;align-items:center;height:34px}.COBsKq_projectRow .COBsKq_rowActions{height:20px}.COBsKq_sessionRow{height:32px;animation:COBsKq_row-in .15s var(--ds-ease-in-out);gap:0}.COBsKq_sessionRow .COBsKq_title{margin:0 6px 0 4px}.COBsKq_flatSessionRowWithoutStatus .COBsKq_title{margin-left:0}@keyframes COBsKq_row-in{0%{opacity:0}}.COBsKq_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.COBsKq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.COBsKq_folderActive{color:var(--dsw-alias-state-business-primary)}.COBsKq_projectRow .COBsKq_chevron{display:none}.COBsKq_projectRow:hover .COBsKq_chevron{display:inline-flex}.COBsKq_projectRow:hover .COBsKq_folder{display:none}.COBsKq_arrow{transition:transform .15s var(--ds-ease-in-out)}.COBsKq_arrowOpen{transform:rotate(90deg)}.COBsKq_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.COBsKq_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.COBsKq_renameInput{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.COBsKq_sessionRow .COBsKq_title{scroll-behavior:smooth;flex:1}@media (hover:hover){.COBsKq_sessionRow:hover .COBsKq_title{text-overflow:clip}}.COBsKq_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.COBsKq_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.COBsKq_scheduleIndicator{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex}.COBsKq_searchScheduleIndicator{margin-left:4px;margin-right:0}.COBsKq_dot{flex:none}.COBsKq_rowActions{flex:none;align-items:center;gap:12px;display:none}.COBsKq_projectRow:hover .COBsKq_rowActions,.COBsKq_sessionRow:hover .COBsKq_rowActions,.COBsKq_projectRow.COBsKq_menuOpen .COBsKq_rowActions,.COBsKq_sessionRow.COBsKq_menuOpen .COBsKq_rowActions{display:inline-flex}.COBsKq_sessionRow:hover .COBsKq_time,.COBsKq_sessionRow.COBsKq_menuOpen .COBsKq_time{display:none}.COBsKq_projectRow.COBsKq_menuOpen,.COBsKq_sessionRow.COBsKq_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.COBsKq_sessionRow.COBsKq_dropBefore,.COBsKq_sessionRow.COBsKq_dropAfter{position:relative}.COBsKq_sessionRow.COBsKq_dropBefore:before,.COBsKq_sessionRow.COBsKq_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.COBsKq_sessionRow.COBsKq_dropBefore:before{top:-7px}.COBsKq_sessionRow.COBsKq_dropAfter:after{bottom:-7px}.COBsKq_hoverContent{flex-direction:column;gap:8px;display:flex}.COBsKq_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.COBsKq_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.COBsKq_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.COBsKq_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.COBsKq_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.COBsKq_iconButton:hover{color:var(--dsw-alias-label-primary)}.COBsKq_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.COBsKq_sessionRow,.COBsKq_arrow{transition:none;animation:none}.COBsKq_sessionRow .COBsKq_title{scroll-behavior:auto}}";
		...
		var Rows_module_css_default = {
			"arrow": "COBsKq_arrow",
			"arrowOpen": "COBsKq_arrowOpen",
			"chevron": "COBsKq_chevron",
			"dot": "COBsKq_dot",
			"dropAfter": "COBsKq_dropAfter",
			"dropBefore": "COBsKq_dropBefore",
			"flatSessionRowWithoutStatus": "COBsKq_flatSessionRowWithoutStatus",
			"folder": "COBsKq_folder",
			"folderActive": "COBsKq_folderActive",
			"hoverContent": "COBsKq_hoverContent",
			"hoverPath": "COBsKq_hoverPath",
			"hoverStatus": "COBsKq_hoverStatus",
			"hoverTime": "COBsKq_hoverTime",
			"hoverTitle": "COBsKq_hoverTitle",
			"iconButton": "COBsKq_iconButton",
			"menuOpen": "COBsKq_menuOpen",
			"meta": "COBsKq_meta",
			"projectRow": "COBsKq_projectRow",
			"projectText": "COBsKq_projectText",
			"renameInput": "COBsKq_renameInput",
			"row-in": "COBsKq_row-in",
			"rowActions": "COBsKq_rowActions",
			"scheduleIndicator": "COBsKq_scheduleIndicator",
			"searchResultHeading": "COBsKq_searchResultHeading",
			"searchResultMeta": "COBsKq_searchResultMeta",
			"searchResultRow": "COBsKq_searchResultRow",
			"searchResultSnippet": "COBsKq_searchResultSnippet",
			"searchResultTitle": "COBsKq_searchResultTitle",
			"searchResultWorkspace": "COBsKq_searchResultWorkspace",
			"searchScheduleIndicator": "COBsKq_searchScheduleIndicator",
			"selected": "COBsKq_selected",
			"sessionRow": "COBsKq_sessionRow",
			"slot": "COBsKq_slot",
			"time": "COBsKq_time",
			"title": "COBsKq_title",
			"visuallyHidden": "COBsKq_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = ".KnFH9a_modalAction{min-width:72px}.KnFH9a_modalError,.KnFH9a_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.KnFH9a_modalError{color:var(--dsw-alias-state-error-primary)}.KnFH9a_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "KnFH9a_menuStatus",
			"modalAction": "KnFH9a_modalAction",
			"modalError": "KnFH9a_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-workspace/src/client/rows/WorkspaceBrowser.module.css.mjs
		const css = ".TWaiYG_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.TWaiYG_root.TWaiYG_rail{padding-right:0}.TWaiYG_iconButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.TWaiYG_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.TWaiYG_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.TWaiYG_root:not(.TWaiYG_rail) .TWaiYG_sectionHeader{margin-top:2px;margin-right:-4px}.TWaiYG_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.TWaiYG_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.TWaiYG_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.TWaiYG_searchSlotExpanded{max-width:100%;padding-left:0}.TWaiYG_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.TWaiYG_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.TWaiYG_search{box-sizing:border-box;corner-shape:round;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.TWaiYG_searchExpanded{border:.5px solid var(--dsw-alias-border-l4);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.TWaiYG_searchButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.TWaiYG_searchExpanded .TWaiYG_searchButton{width:28px;height:30px}.TWaiYG_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.TWaiYG_searchExpanded .TWaiYG_searchButton:hover{background:0 0}.TWaiYG_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.TWaiYG_searchExpanded .TWaiYG_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.TWaiYG_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.TWaiYG_clearButton{corner-shape:round;cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.TWaiYG_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.TWaiYG_rail .TWaiYG_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.TWaiYG_rail .TWaiYG_headerActions{max-width:none}.TWaiYG_rail .TWaiYG_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary);border-radius:12px}.TWaiYG_rail .TWaiYG_search{background:0 0;border-color:#0000;border-radius:12px;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.TWaiYG_rail .TWaiYG_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary);border-radius:12px}.TWaiYG_rail .TWaiYG_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.TWaiYG_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.TWaiYG_rail .TWaiYG_listArea{margin-left:0;margin-right:0;padding-left:0}.TWaiYG_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.TWaiYG_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}[data-platform=darwin] .TWaiYG_fade{display:none}.TWaiYG_wide{animation:TWaiYG_wide-in .2s var(--ds-ease-in-out)}@keyframes TWaiYG_wide-in{0%{opacity:0}}.TWaiYG_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.TWaiYG_flatList>*+*,.TWaiYG_searchTree>[role=treeitem]+[role=treeitem],.TWaiYG_groupSection>*+*{margin-top:2px}.TWaiYG_searchStatus,.TWaiYG_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.TWaiYG_searchWarning{color:var(--dsw-alias-label-secondary)}.TWaiYG_groupSection{position:relative}.TWaiYG_groupSection+.TWaiYG_groupSection{margin-top:4px}.TWaiYG_listTopDropIndicator,.TWaiYG_workspaceDropBefore:before,.TWaiYG_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.TWaiYG_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.TWaiYG_listTopDropActive>.TWaiYG_workspaceDropBefore:first-child:before{display:none}.TWaiYG_workspaceDropBefore:before{top:-8px}.TWaiYG_workspaceDropAfter:after{bottom:-8px}.TWaiYG_sessionOverflowButton{width:100%;height:28px;padding:0 12px 0 calc(28px + var(--dsh-workspace-indent,0px));cursor:pointer;text-align:left;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;font-size:12px}.TWaiYG_groupSection>.TWaiYG_sessionOverflowButton{margin-top:0}.TWaiYG_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.TWaiYG_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.TWaiYG_renameInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.TWaiYG_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.TWaiYG_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.TWaiYG_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.TWaiYG_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.TWaiYG_wide{animation:none}.TWaiYG_search,.TWaiYG_sectionLabel,.TWaiYG_searchSlot,.TWaiYG_searchInput,.TWaiYG_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "TWaiYG_clearButton",
			"deleteAction": "TWaiYG_deleteAction",
			"deleteStatus": "TWaiYG_deleteStatus",
			"empty": "TWaiYG_empty",
			"fade": "TWaiYG_fade",
			"flatList": "TWaiYG_flatList",
			"groupSection": "TWaiYG_groupSection",
			"headerActions": "TWaiYG_headerActions",
			"headerActionsHidden": "TWaiYG_headerActionsHidden",
			"iconButton": "TWaiYG_iconButton",
			"list": "TWaiYG_list",
			"listArea": "TWaiYG_listArea",
			"listTopDropActive": "TWaiYG_listTopDropActive",
			"listTopDropIndicator": "TWaiYG_listTopDropIndicator",
			"rail": "TWaiYG_rail",
			"renameError": "TWaiYG_renameError",
			"renameInput": "TWaiYG_renameInput",
			"root": "TWaiYG_root",
			"search": "TWaiYG_search",
			"searchButton": "TWaiYG_searchButton",
			"searchExpanded": "TWaiYG_searchExpanded",
			"searchInput": "TWaiYG_searchInput",
			"searchSlot": "TWaiYG_searchSlot",
			"searchSlotExpanded": "TWaiYG_searchSlotExpanded",
			"searchStatus": "TWaiYG_searchStatus",
			"searchTree": "TWaiYG_searchTree",
			"searchWarning": "TWaiYG_searchWarning",
			"sectionHeader": "TWaiYG_sectionHeader",
			"sectionLabel": "TWaiYG_sectionLabel",
			"sectionLabelHidden": "TWaiYG_sectionLabelHidden",
			"sessionOverflowButton": "TWaiYG_sessionOverflowButton",
			"treeBody": "TWaiYG_treeBody",
			"wide": "TWaiYG_wide",
			"wide-in": "TWaiYG_wide-in",
			"workspaceDropAfter": "TWaiYG_workspaceDropAfter",
			"workspaceDropBefore": "TWaiYG_workspaceDropBefore"
		};
		//#endregion
