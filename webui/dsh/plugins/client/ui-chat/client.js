window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/MessageItem.module.css.mjs
		const css$15 = ".ZQiA0a_userRow{flex-direction:column;align-items:flex-end;gap:6px;display:flex}.ZQiA0a_userStack{min-width:0;max-width:min(calc(var(--dsh-chat-content-width,748px) * .702), 82%);flex-direction:column;align-items:flex-end;gap:8px;display:flex}.ZQiA0a_bubble{background:var(--dsw-specific-bubble);max-width:100%;font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:22px;padding:10px 16px}.ZQiA0a_referenceSummary{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.ZQiA0a_contextRow{padding:2px 0}.ZQiA0a_compactionRow{--dsh-compaction-header-height:calc(24px + var(--dsh-content-font-delta,0px));padding:2px 0}.ZQiA0a_compactionButton{width:100%;height:var(--dsh-compaction-header-height);min-width:0;color:inherit;font:inherit;text-align:left;background:0 0;border:none;border-radius:6px;align-items:center;padding:0;display:flex}.ZQiA0a_compactionRow:has(.ZQiA0a_compactionBody) .ZQiA0a_compactionButton{z-index:7;background:var(--dsw-alias-bg-base);border-radius:0;position:sticky;top:0}.ZQiA0a_compactionBody :has(>[data-code-block-banner]){top:var(--dsh-compaction-header-height)}.ZQiA0a_compactionRow:has(.ZQiA0a_compactionBody) .ZQiA0a_compactionButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.ZQiA0a_compactionButton:not(:disabled){cursor:pointer}.ZQiA0a_compactionButton:not(:disabled):hover{background:var(--dsw-alias-interactive-bg-hover)}.ZQiA0a_compactionLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none;place-items:center;margin-right:6px;display:inline-grid}.ZQiA0a_compactionLeading svg{width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.ZQiA0a_compactionContextIcon,.ZQiA0a_compactionDisclosureIcon{grid-area:1/1;justify-content:center;align-items:center;display:inline-flex}.ZQiA0a_compactionDisclosureIcon,.ZQiA0a_compactionButton:not(:disabled):hover .ZQiA0a_compactionContextIcon,.ZQiA0a_compactionButton:not(:disabled):focus-visible .ZQiA0a_compactionContextIcon{opacity:0}.ZQiA0a_compactionButton:not(:disabled):hover .ZQiA0a_compactionDisclosureIcon,.ZQiA0a_compactionButton:not(:disabled):focus-visible .ZQiA0a_compactionDisclosureIcon{opacity:1}.ZQiA0a_compactionTitle{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary-dimmed);flex:none}.ZQiA0a_compactionSep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.ZQiA0a_compactionSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.ZQiA0a_compactionBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}.ZQiA0a_retryRow{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px))}.ZQiA0a_retrySummary{width:fit-content;color:inherit;cursor:pointer;user-select:none;border-radius:3px;align-items:center;gap:7px;padding:2px 0;list-style:none;display:inline-flex}.ZQiA0a_retrySummary::-webkit-details-marker{display:none}.ZQiA0a_retrySummary:after{content:\"\";opacity:.8;border-bottom:1.5px solid;border-right:1.5px solid;width:6px;height:6px;transition:transform .12s;transform:rotate(-45deg)}.ZQiA0a_retrySummary:hover{color:var(--dsw-alias-label-secondary)}.ZQiA0a_retrySummary:focus-visible{outline:1.5px solid var(--dsw-alias-button-info-fill);outline-offset:2px}.ZQiA0a_retryText{color:inherit}.ZQiA0a_retryRow[data-active] .ZQiA0a_retryText{background:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-tertiary) 40%, var(--dsw-alias-label-secondary) 50%, var(--dsw-alias-label-tertiary) 60%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-position:100%;background-size:200% 100%;background-clip:text;animation:1.6s ease-in-out infinite ZQiA0a_retry-shimmer}.ZQiA0a_retryRow[open] .ZQiA0a_retrySummary:after{transform:rotate(45deg)}.ZQiA0a_retryDetails{overflow-wrap:anywhere;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));gap:2px;margin-top:3px;padding-left:14px;display:grid}.ZQiA0a_retryDetailLabel{color:var(--dsw-alias-label-secondary)}.ZQiA0a_turnErrorRow{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));grid-template-columns:10px minmax(0,1fr) auto;align-items:start;gap:8px;padding:2px 0;display:grid}.ZQiA0a_turnErrorDot{margin-top:5px}.ZQiA0a_turnErrorCopy{overflow-wrap:anywhere;min-width:0}.ZQiA0a_turnErrorTitle{color:var(--dsw-alias-state-error-primary);margin-right:6px;font-weight:600}.ZQiA0a_turnErrorMessage{color:var(--dsw-alias-label-secondary)}.ZQiA0a_turnErrorCode{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-markdown-code-block-small)}.ZQiA0a_maxTokensTitle{color:var(--dsw-alias-state-warn-primary);margin-right:6px;font-weight:600}@keyframes ZQiA0a_retry-shimmer{0%{background-position:100%}to{background-position:0}}@media (prefers-reduced-motion:reduce){.ZQiA0a_retryRow[data-active] .ZQiA0a_retryText{color:inherit;background:0 0;animation:none}}.ZQiA0a_attachmentRow{flex-wrap:wrap;justify-content:flex-end;gap:8px;max-width:100%;display:flex}.ZQiA0a_fileCard{border:.5px solid var(--dsw-alias-border-l2,#0000001f);background:var(--dsw-specific-input-major,transparent);box-sizing:border-box;border-radius:16px;flex:0 0 240px;align-items:center;gap:10px;width:240px;min-height:64px;padding:8px 12px;display:inline-flex}.ZQiA0a_fileIcon{flex:none;width:28px;height:28px}.ZQiA0a_fileContent{flex-direction:column;flex:1;min-width:0;display:flex}.ZQiA0a_fileName{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px;overflow:hidden}.ZQiA0a_fileMeta{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-tertiary,#00000073);font-size:12px;line-height:15px;overflow:hidden}";
		...
		var MessageItem_module_css_default = {
			"attachmentRow": "ZQiA0a_attachmentRow",
			"bubble": "ZQiA0a_bubble",
			"compactionBody": "ZQiA0a_compactionBody",
			"compactionButton": "ZQiA0a_compactionButton",
			"compactionContextIcon": "ZQiA0a_compactionContextIcon",
			"compactionDisclosureIcon": "ZQiA0a_compactionDisclosureIcon",
			"compactionLeading": "ZQiA0a_compactionLeading",
			"compactionRow": "ZQiA0a_compactionRow",
			"compactionSep": "ZQiA0a_compactionSep",
			"compactionSummary": "ZQiA0a_compactionSummary",
			"compactionTitle": "ZQiA0a_compactionTitle",
			"contextRow": "ZQiA0a_contextRow",
			"fileCard": "ZQiA0a_fileCard",
			"fileContent": "ZQiA0a_fileContent",
			"fileIcon": "ZQiA0a_fileIcon",
			"fileMeta": "ZQiA0a_fileMeta",
			"fileName": "ZQiA0a_fileName",
			"maxTokensTitle": "ZQiA0a_maxTokensTitle",
			"referenceSummary": "ZQiA0a_referenceSummary",
			"retry-shimmer": "ZQiA0a_retry-shimmer",
			"retryDetailLabel": "ZQiA0a_retryDetailLabel",
			"retryDetails": "ZQiA0a_retryDetails",
			"retryRow": "ZQiA0a_retryRow",
			"retrySummary": "ZQiA0a_retrySummary",
			"retryText": "ZQiA0a_retryText",
			"turnErrorCode": "ZQiA0a_turnErrorCode",
			"turnErrorCopy": "ZQiA0a_turnErrorCopy",
			"turnErrorDot": "ZQiA0a_turnErrorDot",
			"turnErrorMessage": "ZQiA0a_turnErrorMessage",
			"turnErrorRow": "ZQiA0a_turnErrorRow",
			"turnErrorTitle": "ZQiA0a_turnErrorTitle",
			"userRow": "ZQiA0a_userRow",
			"userStack": "ZQiA0a_userStack"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/ContextBody.module.css.mjs
		const css$14 = ".VLBnCG_text{color:var(--dsw-alias-label-secondary);font:inherit;white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.VLBnCG_fields{border-top:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:2px;margin:8px 0 0;padding-top:8px;display:flex}.VLBnCG_field{gap:8px;min-width:0;display:flex}.VLBnCG_fieldKey{min-width:96px;color:var(--dsw-alias-label-caption);flex:none}.VLBnCG_fieldValue{min-width:0;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;flex:auto;margin:0}.VLBnCG_files{flex-wrap:wrap;gap:4px 12px;margin:0 0 8px;padding:0;list-style:none;display:flex}.VLBnCG_file{align-items:baseline;gap:6px;min-width:0;display:flex}.VLBnCG_filePath{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.VLBnCG_fileAction{color:var(--dsw-alias-label-caption)}.VLBnCG_catalogNotice{color:var(--dsw-alias-label-caption);margin:0 0 6px}.VLBnCG_entries{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.VLBnCG_entry{gap:8px;min-width:0;display:flex}.VLBnCG_entryName{color:var(--dsw-alias-label-secondary);flex:none}.VLBnCG_entryDescription{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.VLBnCG_sections{flex-direction:column;gap:8px;margin:0;display:flex}.VLBnCG_section{flex-direction:column;gap:2px;min-width:0;display:flex}.VLBnCG_sectionName{color:var(--dsw-alias-label-caption)}.VLBnCG_sectionText{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.VLBnCG_relaySender{color:var(--dsw-alias-label-caption);overflow-wrap:anywhere;margin:0 0 6px}.VLBnCG_recalls{flex-direction:column;gap:2px;margin:0 0 8px;padding:0;list-style:none;display:flex}.VLBnCG_recall{gap:8px;min-width:0;display:flex}.VLBnCG_recallLabel{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.VLBnCG_recallCounts{color:var(--dsw-alias-label-caption);flex:none}";
		...
		var ContextBody_module_css_default = {
			"catalogNotice": "VLBnCG_catalogNotice",
			"entries": "VLBnCG_entries",
			"entry": "VLBnCG_entry",
			"entryDescription": "VLBnCG_entryDescription",
			"entryName": "VLBnCG_entryName",
			"field": "VLBnCG_field",
			"fieldKey": "VLBnCG_fieldKey",
			"fieldValue": "VLBnCG_fieldValue",
			"fields": "VLBnCG_fields",
			"file": "VLBnCG_file",
			"fileAction": "VLBnCG_fileAction",
			"filePath": "VLBnCG_filePath",
			"files": "VLBnCG_files",
			"recall": "VLBnCG_recall",
			"recallCounts": "VLBnCG_recallCounts",
			"recallLabel": "VLBnCG_recallLabel",
			"recalls": "VLBnCG_recalls",
			"relaySender": "VLBnCG_relaySender",
			"section": "VLBnCG_section",
			"sectionName": "VLBnCG_sectionName",
			"sectionText": "VLBnCG_sectionText",
			"sections": "VLBnCG_sections",
			"text": "VLBnCG_text"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/ContextInjectionRow.module.css.mjs
		const css$13 = ".X1IevW_root{min-width:0}.X1IevW_root[data-open]{padding-bottom:4px}.X1IevW_chevron{color:var(--dsw-alias-label-secondary)}.X1IevW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.X1IevW_source{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.X1IevW_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.X1IevW_body{box-sizing:border-box;width:calc(100% - 22px - var(--dsh-content-font-delta,0px));max-height:141px;margin:4px 0 0 calc(22px + var(--dsh-content-font-delta,0px));background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-tertiary);font:400 11px/16px var(--ds-font-family-code);border:none;border-radius:8px;padding:10px 16px 12px 12px;overflow:auto}";
		...
		var ContextInjectionRow_module_css_default = {
			"body": "X1IevW_body",
			"chevron": "X1IevW_chevron",
			"root": "X1IevW_root",
			"sep": "X1IevW_sep",
			"source": "X1IevW_source",
			"summary": "X1IevW_summary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/MessageIconActions.module.css.mjs
		const css$12 = ".QBcvvq_actions{height:calc(28px + var(--dsh-content-font-delta,0px));align-items:center;gap:8px;display:flex}.QBcvvq_timeStart{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-right:12px}.QBcvvq_timeEnd{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap}@media (hover:hover){[data-actions-reveal=hover] .QBcvvq_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])) .QBcvvq_actions{opacity:0;transition:opacity 80ms}[data-actions-reveal=hover]:hover .QBcvvq_actions,[data-actions-reveal=hover]:focus-within .QBcvvq_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])):hover .QBcvvq_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])):focus-within .QBcvvq_actions{opacity:1}}.QBcvvq_action{width:calc(28px + var(--dsh-content-font-delta,0px));height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.QBcvvq_action svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px))}.QBcvvq_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.QBcvvq_action[data-unavailable]{cursor:default;opacity:.4}.QBcvvq_action[data-unavailable]:hover{color:var(--dsw-alias-label-tertiary);background:0 0}.QBcvvq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var MessageIconActions_module_css_default = {
			"action": "QBcvvq_action",
			"actions": "QBcvvq_actions",
			"timeEnd": "QBcvvq_timeEnd",
			"timeStart": "QBcvvq_timeStart",
			"visuallyHidden": "QBcvvq_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/ChatView.module.css.mjs
		const css$11 = ".D3sc8a_root{flex-direction:column;flex:auto;min-height:0;display:flex;position:relative}.D3sc8a_scroll{min-height:0;padding:16px calc(var(--dsh-composer-side-clearance) + 16px);flex:auto;overflow-y:auto;container-type:inline-size}[data-conversation-scroll] .D3sc8a_root{flex:none;height:auto;min-height:auto}[data-conversation-scroll] .D3sc8a_scroll{flex:none;min-height:auto;overflow:visible}.D3sc8a_column{max-width:var(--dsh-chat-content-width);flex-direction:column;width:100%;margin:0 auto;display:flex}.D3sc8a_column>:not([hidden]):not(.D3sc8a_flowItem:empty)~:not([hidden]):not(.D3sc8a_flowItem:empty){margin-top:var(--dsh-chat-flow-gap,16px)}.D3sc8a_flowItem{min-width:0}.D3sc8a_flowItem[data-turn-process-answer]{--dsh-chat-flow-gap:8px}.D3sc8a_flowItem:empty{display:none}.D3sc8a_callRow{border-radius:6px}.D3sc8a_turnStatus{height:calc(26px + var(--dsh-content-font-delta,0px));font:var(--dsw-font-s-strong-14);font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));white-space:nowrap;background:linear-gradient(90deg, var(--dsw-static-deepseek-500) 0%, var(--dsw-static-deepseek-500) 40%, var(--dsw-static-deepseek-200) 50%, var(--dsw-static-deepseek-500) 60%, var(--dsw-static-deepseek-500) 100%);color:#0000;-webkit-text-fill-color:transparent;background-position:100% 0;background-size:250% 100%;-webkit-background-clip:text;background-clip:text;flex:none;align-self:flex-start;align-items:center;animation:1.8s linear infinite D3sc8a_dsh-turn-status-shimmer;display:inline-flex}.D3sc8a_turnStatusClock{font:var(--dsw-font-xs-13);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-caption);-webkit-text-fill-color:var(--dsw-alias-label-caption);margin-left:8px;font-weight:400}@keyframes D3sc8a_dsh-turn-status-shimmer{to{background-position:0 0}}@media (prefers-reduced-motion:reduce){.D3sc8a_turnStatus{background-position:0 0;background-size:100% 100%;animation:none}}.D3sc8a_hint{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.D3sc8a_openError{color:var(--dsw-alias-state-error-primary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.D3sc8a_older{justify-content:center;display:flex}.D3sc8a_older button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover-solid);cursor:pointer;border:none;border-radius:14px;padding:4px 12px;font-size:12px}.D3sc8a_older button:disabled{cursor:default;opacity:.6}.D3sc8a_toBottomSlot{z-index:8;height:0;padding-right:max(0px, calc((100% - var(--dsh-chat-content-width)) / 2));pointer-events:none;justify-content:flex-end;display:flex;position:sticky;bottom:16px}[data-conversation-scroll] .D3sc8a_toBottomSlot{bottom:calc(var(--dsh-composer-height,152px) + 16px)}.D3sc8a_toBottom{--dsw-elevation-stroke-color:var(--dsw-alias-border-l3);corner-shape:round;width:34px;height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-floating-fill);box-shadow:var(--dsw-elevation-panel);cursor:pointer;pointer-events:auto;border:0;border-radius:100px;justify-content:center;align-items:center;margin-top:-34px;padding:0;display:flex}.D3sc8a_toBottom:hover{background:var(--dsw-alias-button-floating-hover)}.D3sc8a_modalAction{min-width:72px}";
		...
		var ChatView_module_css_default = {
			"callRow": "D3sc8a_callRow",
			"column": "D3sc8a_column",
			"dsh-turn-status-shimmer": "D3sc8a_dsh-turn-status-shimmer",
			"flowItem": "D3sc8a_flowItem",
			"hint": "D3sc8a_hint",
			"modalAction": "D3sc8a_modalAction",
			"older": "D3sc8a_older",
			"openError": "D3sc8a_openError",
			"root": "D3sc8a_root",
			"scroll": "D3sc8a_scroll",
			"toBottom": "D3sc8a_toBottom",
			"toBottomSlot": "D3sc8a_toBottomSlot",
			"turnStatus": "D3sc8a_turnStatus",
			"turnStatusClock": "D3sc8a_turnStatusClock"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/TurnNavigator.module.css.mjs
		const css$10 = ".bPKZpW_slot{z-index:7;pointer-events:none;height:0;position:sticky;top:0}.bPKZpW_frame{--turn-rail-band:calc(var(--dsh-conversation-viewport-height,100dvh) - var(--dsh-composer-height,152px));--turn-preview-height:100px;top:calc(var(--turn-rail-band) / 2);right:calc(12px - (var(--dsh-composer-side-clearance) + 16px));width:28px;height:min(var(--turn-natural-height), max(0px, calc(var(--turn-rail-band) - 64px)), 420px);cursor:pointer;pointer-events:auto;transition:height .22s cubic-bezier(.2,.8,.2,1);position:absolute;transform:translateY(-50%)}.bPKZpW_scroller{overscroll-behavior:contain;scrollbar-width:none;position:absolute;inset:0;overflow-y:auto}.bPKZpW_scroller::-webkit-scrollbar{display:none}.bPKZpW_fadeTop{mask-image:linear-gradient(#0000 0,#000 24px 100%)}.bPKZpW_fadeBottom{mask-image:linear-gradient(#000 0 calc(100% - 24px),#0000 100%)}.bPKZpW_fadeTop.bPKZpW_fadeBottom{mask-image:linear-gradient(#0000 0,#000 24px calc(100% - 24px),#0000 100%)}.bPKZpW_marks{height:var(--turn-natural-height);position:relative}.bPKZpW_markPosition{top:calc(var(--turn-natural-position) + var(--turn-rail-inset));height:10px;transition:top .22s cubic-bezier(.2,.8,.2,1);animation:.15s ease-out bPKZpW_dsh-turn-mark-enter;position:absolute;left:0;right:0;transform:translateY(-50%)}.bPKZpW_mark{cursor:pointer;pointer-events:none;background:0 0;border:0;border-radius:8px;width:20px;padding:0;position:absolute;inset:0 0 0 auto}.bPKZpW_mark:before{background:var(--dsw-alias-border-l4);content:\"\";border-radius:2px;width:12px;height:2px;transition:width .14s,background-color .14s;position:absolute;top:50%;right:0;transform:translateY(-50%)}.bPKZpW_markUnloaded:before{opacity:.6;width:8px}.bPKZpW_markPreview:before{background:var(--dsw-alias-label-tertiary);width:18px}.bPKZpW_markBusy:before{animation:1s ease-in-out infinite bPKZpW_dsh-turn-mark-busy}.bPKZpW_markActive:before{background:var(--dsw-alias-label-primary);width:20px}.bPKZpW_mark:focus-visible:before{background:var(--dsw-alias-state-business-primary);width:20px}.bPKZpW_mark:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.bPKZpW_preview{top:clamp(0px, calc(var(--turn-natural-position) + var(--turn-rail-inset) - var(--turn-scroll-top,0px) - var(--turn-preview-height) / 2), calc(100% - var(--turn-preview-height)));box-sizing:border-box;width:min(300px,100cqw - 120px);max-height:var(--turn-preview-height);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--dsw-elevation-panel);pointer-events:none;border:0;border-radius:10px;padding:10px 12px;transition:top .14s cubic-bezier(.2,.8,.2,1);animation:.12s ease-out bPKZpW_dsh-turn-preview-enter;position:absolute;right:calc(100% + 10px);overflow:hidden}.bPKZpW_previewPrompt,.bPKZpW_previewResponse{-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.bPKZpW_previewPrompt{font:var(--dsw-font-xs-strong-13);-webkit-line-clamp:1}.bPKZpW_previewResponse{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xxs-12);-webkit-line-clamp:3;margin-top:4px}@keyframes bPKZpW_dsh-turn-mark-enter{0%{opacity:0}to{opacity:1}}@keyframes bPKZpW_dsh-turn-preview-enter{0%{opacity:0;transform:translate(4px)}to{opacity:1;transform:translate(0)}}@keyframes bPKZpW_dsh-turn-mark-busy{0%,to{opacity:1}50%{opacity:.35}}@container (width<=900px){.bPKZpW_slot{display:none}}@media (prefers-reduced-motion:reduce){.bPKZpW_frame,.bPKZpW_scroller,.bPKZpW_markPosition,.bPKZpW_mark:before,.bPKZpW_markBusy:before,.bPKZpW_preview{scroll-behavior:auto;transition:none;animation:none}}";
		...
		var TurnNavigator_module_css_default = {
			"dsh-turn-mark-busy": "bPKZpW_dsh-turn-mark-busy",
			"dsh-turn-mark-enter": "bPKZpW_dsh-turn-mark-enter",
			"dsh-turn-preview-enter": "bPKZpW_dsh-turn-preview-enter",
			"fadeBottom": "bPKZpW_fadeBottom",
			"fadeTop": "bPKZpW_fadeTop",
			"frame": "bPKZpW_frame",
			"mark": "bPKZpW_mark",
			"markActive": "bPKZpW_markActive",
			"markBusy": "bPKZpW_markBusy",
			"markPosition": "bPKZpW_markPosition",
			"markPreview": "bPKZpW_markPreview",
			"markUnloaded": "bPKZpW_markUnloaded",
			"marks": "bPKZpW_marks",
			"preview": "bPKZpW_preview",
			"previewPrompt": "bPKZpW_previewPrompt",
			"previewResponse": "bPKZpW_previewResponse",
			"scroller": "bPKZpW_scroller",
			"slot": "bPKZpW_slot"
		};
		//#endregion
		...
		*/
		function observedRpcIds(order, nodes, inbox) {
			...
			for (const { source } of [...inbox?.["next-turn"] ?? [], ...inbox?.["next-step"] ?? []]) if (source.kind === "user" && "rpcId" in source) observed.add(source.rpcId);
			return observed;
		}
		...
		*/
		function ChatView({ useSession, useChat, useChatNode, useChatNodeProcess, useSessions, useStore, actions, renderSlot, sessionId, openFile, openSkill, openExternalLink, loadOlder, loadThrough, loadImage, openView, chatScroll, forkAt, fileMentions, useTranscriptView, useProjection, t }) {
			...
			const pendingSteering = (0, react.useMemo)(() => inbox?.["next-step"].filter((message) => message.source.kind === "user") ?? [], [inbox]);
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/accessibility.module.css.mjs
		const css$9 = ".YAM9wG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var accessibility_module_css_default = { "visuallyHidden": "YAM9wG_visuallyHidden" };
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/ReasoningRow.module.css.mjs
		const css$8 = ".QO0x1G_root{flex-direction:column;display:flex}.QO0x1G_root:not([data-expanded]){contain:size layout;height:calc(24px + var(--dsh-content-font-delta,0px))}.QO0x1G_row{position:relative;overflow:hidden}.QO0x1G_root[data-expanded] [data-open] [data-disclosure-row]{z-index:1;background:var(--dsw-alias-bg-base);position:sticky;top:0}.QO0x1G_root[data-state=running] .QO0x1G_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite QO0x1G_dsh-reasoning-row-sweep;position:absolute;left:0}@keyframes QO0x1G_dsh-reasoning-row-sweep{0%{left:-300px}90%,to{left:100%}}.QO0x1G_leading{flex-shrink:0}.QO0x1G_chevron{color:var(--dsw-alias-label-secondary)}.QO0x1G_title{font-weight:400}.QO0x1G_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.QO0x1G_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));white-space:nowrap;flex:auto;overflow:hidden}.QO0x1G_summaryText{text-overflow:ellipsis;display:block;overflow:hidden}.QO0x1G_summary[data-follow-end]{justify-content:flex-end;display:flex}.QO0x1G_summary[data-follow-end] .QO0x1G_summaryText{text-align:start;text-overflow:clip;flex:none;width:max-content;min-width:100%;overflow:visible}.QO0x1G_thinkBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));min-width:0}@media (prefers-reduced-motion:reduce){.QO0x1G_root[data-state=running] .QO0x1G_row:after{animation:none}}";
		...
		var ReasoningRow_module_css_default = {
			"chevron": "QO0x1G_chevron",
			"dsh-reasoning-row-sweep": "QO0x1G_dsh-reasoning-row-sweep",
			"leading": "QO0x1G_leading",
			"root": "QO0x1G_root",
			"row": "QO0x1G_row",
			"separator": "QO0x1G_separator",
			"summary": "QO0x1G_summary",
			"summaryText": "QO0x1G_summaryText",
			"thinkBody": "QO0x1G_thinkBody",
			"title": "QO0x1G_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/AssistantMarkdown.module.css.mjs
		const css$7 = ".O8ZuLW_root{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);flex-direction:column;display:flex}.O8ZuLW_body{flex-direction:column;gap:16px;display:flex}.O8ZuLW_body .md-table-wide{--dsh-table-spare:max(0px, calc((100cqw - var(--dsh-chat-content-width)) / 2));--dsh-table-lead:calc(var(--dsh-table-spare) + min(var(--dsh-chat-content-width), 100cqw) - 100%);box-sizing:border-box;width:calc(100% + var(--dsh-table-lead) + var(--dsh-table-spare));max-width:none;margin-left:calc(-1 * var(--dsh-table-lead));padding-left:var(--dsh-table-lead)}.O8ZuLW_body .md-table-wide>table{z-index:1;position:relative}.O8ZuLW_body>[data-turn-process-inline][hidden]{margin-bottom:-16px}.O8ZuLW_stopped{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-tertiary);border-radius:6px;align-self:flex-start;padding:0 6px;font-size:11px;line-height:18px}.O8ZuLW_actions{margin-top:16px;margin-left:-6px}";
		...
		var AssistantMarkdown_module_css_default = {
			"actions": "O8ZuLW_actions",
			"body": "O8ZuLW_body",
			"root": "O8ZuLW_root",
			"stopped": "O8ZuLW_stopped"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/GenericCommandCard.module.css.mjs
		const css$6 = ".GFW5SW_root{flex-direction:column;display:flex}.GFW5SW_row{position:relative;overflow:hidden}.GFW5SW_root[data-state=running] .GFW5SW_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite GFW5SW_dsh-command-row-sweep;position:absolute;left:0}@keyframes GFW5SW_dsh-command-row-sweep{0%{left:-300px}90%,to{left:100%}}.GFW5SW_leading{flex-shrink:0}.GFW5SW_chevron{color:var(--dsw-alias-label-secondary)}.GFW5SW_title{font-weight:400}.GFW5SW_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.GFW5SW_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.GFW5SW_summary[data-error],.GFW5SW_body[data-error]{color:var(--dsw-alias-state-error-primary)}.GFW5SW_body{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);max-height:260px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;border-radius:12px;margin:4px 0 4px 4px;padding:12px 16px;overflow:auto}@media (prefers-reduced-motion:reduce){.GFW5SW_root[data-state=running] .GFW5SW_row:after{animation:none}}";
		...
		var GenericCommandCard_module_css_default = {
			"body": "GFW5SW_body",
			"chevron": "GFW5SW_chevron",
			"dsh-command-row-sweep": "GFW5SW_dsh-command-row-sweep",
			"leading": "GFW5SW_leading",
			"root": "GFW5SW_root",
			"row": "GFW5SW_row",
			"separator": "GFW5SW_separator",
			"summary": "GFW5SW_summary",
			"title": "GFW5SW_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/TurnProcessNodeView.module.css.mjs
		const css$5 = "._5opACG_root{box-sizing:border-box;border:none;border-bottom:.5px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:33px;color:var(--dsw-alias-label-secondary);cursor:pointer;text-align:left;background:0 0;align-items:center;padding:0 0 8px;display:flex}._5opACG_root:not([data-open]){margin-bottom:8px}._5opACG_chevron{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:6px;transition:transform .1s;transform:rotate(-90deg)}._5opACG_root[data-open] ._5opACG_chevron{transform:rotate(0)}._5opACG_label{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:24px;overflow:hidden}@media (prefers-reduced-motion:reduce){._5opACG_chevron{transition:none}}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/TurnUsagePanel.module.css.mjs
		const css$4 = ".qwLzGa_root{min-width:0;display:inline-flex}.qwLzGa_root+.qwLzGa_root{margin-left:-6px}.qwLzGa_trigger{min-width:0;height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);font-variant-numeric:tabular-nums;line-height:calc(24px + var(--dsh-content-font-delta,0px));white-space:nowrap;cursor:pointer;background:0 0;border:none;border-radius:28px;align-items:center;gap:4px;padding:6px 8px;display:inline-flex}.qwLzGa_label{text-overflow:ellipsis;min-width:0;overflow:hidden}.qwLzGa_trigger svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px));flex:none}.qwLzGa_trigger:hover,.qwLzGa_trigger[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}@media (width<=480px){.qwLzGa_trigger{width:calc(28px + var(--dsh-content-font-delta,0px));justify-content:center;padding:6px}.qwLzGa_trigger .qwLzGa_label{display:none}.qwLzGa_root+.qwLzGa_root{margin-left:0}}";
		...
		var TurnUsagePanel_module_css_default = {
			"label": "qwLzGa_label",
			"root": "qwLzGa_root",
			"trigger": "qwLzGa_trigger"
		};
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/stat-dialog.module.css.mjs
		const css$3 = ".PBMWgW_panel{z-index:1100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:max-content;min-width:min(300px,100vw - 24px);max-width:min(440px,100vw - 24px);box-shadow:var(--dsw-elevation-prominent);color:var(--dsw-alias-label-secondary);cursor:default;border:0;border-radius:12px;padding:16px;font-size:12px;line-height:18px;position:fixed}.PBMWgW_title{color:var(--dsw-alias-label-primary);justify-content:space-between;gap:16px;margin-bottom:8px;font-weight:500;display:flex}.PBMWgW_titleRule{border-top:.5px solid var(--dsw-alias-border-l2);margin-bottom:10px}.PBMWgW_titleValue{font-variant-numeric:tabular-nums}.PBMWgW_titleLabel{align-items:center;gap:6px;min-width:0;display:inline-flex}.PBMWgW_titleLabel svg{flex:none;width:14px;height:14px}.PBMWgW_details{color:var(--dsw-alias-label-tertiary);grid-template-columns:minmax(76px,auto) minmax(0,1fr);gap:6px 16px;margin:0;display:grid}.PBMWgW_details dt,.PBMWgW_details dd{min-width:0;margin:0}.PBMWgW_details dd{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;text-align:right}.PBMWgW_details .PBMWgW_route{overflow-wrap:anywhere}.PBMWgW_reasoning{color:var(--dsw-alias-label-tertiary);white-space:nowrap}";
		...
		var stat_dialog_module_css_default = {
			"details": "PBMWgW_details",
			"panel": "PBMWgW_panel",
			"reasoning": "PBMWgW_reasoning",
			"route": "PBMWgW_route",
			"title": "PBMWgW_title",
			"titleLabel": "PBMWgW_titleLabel",
			"titleRule": "PBMWgW_titleRule",
			"titleValue": "PBMWgW_titleValue"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/TurnTailNodeView.module.css.mjs
		const css$2 = ".jcix4G_root{flex-direction:column;gap:16px;display:flex}.jcix4G_actions{margin-top:4px;margin-left:-6px}";
		...
		var TurnTailNodeView_module_css_default = {
			"actions": "jcix4G_actions",
			"root": "jcix4G_root"
		};
		//#endregion
		//#region lib/types/client/chat/TurnTailNodeView.js
		/** Turn-local actions and feature tail over the Location index, independent of Assistant placement. */
		const TurnTailNodeView = (0, react.memo)(function TurnTailNodeView({ node, openFile, forkAt, renderSlot, t, useChat }) {
			const data = node.data;
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/chat/StatsPills.module.css.mjs
		const css$1 = ".aH8oJG_root{box-sizing:border-box;min-width:0;max-width:100%;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));justify-content:center;gap:12px;display:flex}.aH8oJG_anchor{min-width:0;display:inline-flex}.aH8oJG_pill{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-tertiary);font:inherit;font-variant-numeric:tabular-nums;line-height:inherit;white-space:nowrap;background:0 0;border:none;border-radius:24px;align-items:center;gap:6px;padding:1px 8px;display:inline-flex}.aH8oJG_pill svg{flex:none;width:14px;height:14px}button.aH8oJG_pill{cursor:pointer}button.aH8oJG_pill:hover,button.aH8oJG_pill[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.aH8oJG_label{text-overflow:ellipsis;min-width:0;overflow:hidden}.aH8oJG_sep{color:var(--dsw-alias-separator-primary);margin:0 6px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-chat/src/client/settings/TranscriptViewRow.module.css.mjs
		const css = ".mnRaFG_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.mnRaFG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.mnRaFG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.mnRaFG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.mnRaFG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.mnRaFG_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.mnRaFG_chevron{flex:none}";
		...
		var TranscriptViewRow_module_css_default = {
			"chevron": "mnRaFG_chevron",
			"desc": "mnRaFG_desc",
			"row": "mnRaFG_row",
			"rowText": "mnRaFG_rowText",
			"selector": "mnRaFG_selector",
			"title": "mnRaFG_title"
		};
		//#endregion
					...
					inject: (sessionId) => {
						...
						return {
							...
							openExternalLink: (url) => {
								if (ctx.get("sidebarRightTabs")?.get("browser") !== void 0) ctx.sidebarRight.openTab("browser", { params: { url } });
