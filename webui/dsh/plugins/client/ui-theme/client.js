window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-theme/src/client/AppearanceRow.module.css.mjs
		const css$1 = ".-rAsdW_group{border-bottom:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.-rAsdW_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.-rAsdW_cubeRow{flex-wrap:wrap;align-items:stretch;gap:8px;display:flex}.-rAsdW_themeCube{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:20px;flex-direction:column;flex:180px;justify-content:center;align-items:center;gap:4px;padding:20px 32px;font-size:14px;line-height:22px;display:flex}.-rAsdW_themeCube:hover:not(.-rAsdW_selected){background:var(--dsw-alias-interactive-bg-hover)}.-rAsdW_selected{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		...
		var AppearanceRow_module_css_default = {
			"cubeRow": "-rAsdW_cubeRow",
			"group": "-rAsdW_group",
			"selected": "-rAsdW_selected",
			"themeCube": "-rAsdW_themeCube",
			"title": "-rAsdW_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-theme/src/client/FontSizeRow.module.css.mjs
		const css = ".-LE8iG_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.-LE8iG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.-LE8iG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.-LE8iG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.-LE8iG_control{align-items:center;gap:8px;display:inline-flex}.-LE8iG_stepper{background:var(--dsw-alias-bg-module-platform);border-radius:18px;justify-content:center;align-items:center;min-width:72px;height:36px;display:inline-flex;position:relative}.-LE8iG_value{text-align:center;font-variant-numeric:tabular-nums;min-width:18px;color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}.-LE8iG_unit{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}.-LE8iG_arrows{opacity:0;flex-direction:column;gap:2px;display:flex;position:absolute;right:8px}.-LE8iG_stepper:hover .-LE8iG_arrows,.-LE8iG_stepper:focus-within .-LE8iG_arrows{opacity:1}.-LE8iG_arrow{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 75%, transparent);width:17px;height:12px;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:3px;justify-content:center;align-items:center;padding:0;display:inline-flex}.-LE8iG_arrow:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.-LE8iG_arrow:disabled{color:var(--dsw-alias-label-caption);cursor:default}";
		...
		var FontSizeRow_module_css_default = {
			"arrow": "-LE8iG_arrow",
			"arrows": "-LE8iG_arrows",
			"control": "-LE8iG_control",
			"desc": "-LE8iG_desc",
			"row": "-LE8iG_row",
			"rowText": "-LE8iG_rowText",
			"stepper": "-LE8iG_stepper",
			"title": "-LE8iG_title",
			"unit": "-LE8iG_unit",
			"value": "-LE8iG_value"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/dsh-src/packages/client/ui-theme/src/styles/base.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/dsh-src/packages/client/ui-theme/src/styles/corner-shape.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/dsh-src/packages/client/ui-theme/src/styles/gradient-shadow-text.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/dsh-src/packages/client/ui-theme/src/styles/shiki.css.mjs
