	...
	factory: (require) => {
		...
		*/
		...
		const en = {
			...
			presetCordisDescription: "Built for creating custom agent presets, with all Standard mode capabilities plus runtime inspection, persistent plugin management, and preset-authoring guidance.",
			duplicate: "Duplicate",
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-agent-preset/src/client/AgentPresetLabel.module.css.mjs
		const css$2 = ".FwVa8G_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.FwVa8G_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-agent-preset/src/client/AgentPresetSeat.module.css.mjs
		const css$1 = ".Jnn6va_menuAnchor{min-width:54px;max-width:100%}.Jnn6va_seat{min-width:0;max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.Jnn6va_seat:not(:disabled):hover,.Jnn6va_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.Jnn6va_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.Jnn6va_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.Jnn6va_seatLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Jnn6va_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both Jnn6va_seat-icon-in}@keyframes Jnn6va_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.Jnn6va_introText{white-space:pre;display:inline-block}.Jnn6va_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards Jnn6va_seat-char-in;display:inline-block}@keyframes Jnn6va_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.Jnn6va_introIcon,.Jnn6va_introChar{opacity:1;animation:none}}.Jnn6va_chevron{color:var(--dsw-alias-label-caption);flex:none}.Jnn6va_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.Jnn6va_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.Jnn6va_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"chevron": "Jnn6va_chevron",
			"introChar": "Jnn6va_introChar",
			"introIcon": "Jnn6va_introIcon",
			"introText": "Jnn6va_introText",
			"item": "Jnn6va_item",
			"itemDesc": "Jnn6va_itemDesc",
			"itemName": "Jnn6va_itemName",
			"menuAnchor": "Jnn6va_menuAnchor",
			"seat": "Jnn6va_seat",
			"seat-char-in": "Jnn6va_seat-char-in",
			"seat-icon-in": "Jnn6va_seat-icon-in",
			"seatIcon": "Jnn6va_seatIcon",
			"seatLabel": "Jnn6va_seatLabel"
		};
		//#endregion
		...
		*/
		function AgentPresetSeat({ sessionId, useSessionRetainInfo, load, select, introduced, useAgentPresetSeat, t }) {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-src/packages/client/ui-agent-preset/src/client/AgentPresetSection.module.css.mjs
		const css = ".R44rTa_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.R44rTa_title{margin:0;font-size:18px;font-weight:600}.R44rTa_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.R44rTa_pickerPreference{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-module-platform);border-radius:14px;justify-content:space-between;align-items:flex-start;gap:20px;padding:14px 16px;display:flex}.R44rTa_pickerPreferenceCopy{gap:4px;min-width:0;display:grid}.R44rTa_pickerPreferenceTitleRow{align-items:center;gap:6px;min-width:0;display:flex}.R44rTa_pickerPreferenceTitle{font-size:14px;font-weight:600;line-height:1.5}.R44rTa_pickerPreferenceDescription{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}.R44rTa_group{flex-direction:column;gap:10px;display:flex}.R44rTa_group+.R44rTa_group{margin-top:20px}.R44rTa_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.R44rTa_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.R44rTa_card{border:.5px solid var(--dsw-alias-border-l4);background:0 0;border-radius:20px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.R44rTa_card:hover:not(.R44rTa_cardActive):not(.R44rTa_cardSelectionDisabled){background:var(--dsw-alias-interactive-bg-hover)}.R44rTa_cardActive{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}.R44rTa_cardSelectionDisabled{background:var(--dsw-alias-bg-module-platform)}.R44rTa_cardSelectionDisabled .R44rTa_cardMain{opacity:.48}.R44rTa_cardBroken,.R44rTa_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.R44rTa_brokenBadge{corner-shape:round;white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.R44rTa_brokenTip{z-index:1;background:var(--dsw-alias-label-primary);width:max-content;max-width:100%;color:var(--dsw-alias-bg-layer-3);text-align:left;white-space:pre-line;overflow-wrap:anywhere;opacity:0;pointer-events:none;border-radius:6px;padding:6px 8px;font-size:11px;font-weight:400;line-height:1.5;transition:opacity .12s;position:absolute;top:calc(100% + 6px);left:0}.R44rTa_brokenBadge:hover .R44rTa_brokenTip,.R44rTa_cardMain:focus-visible .R44rTa_brokenTip{opacity:1}.R44rTa_cardMain[aria-disabled=true]{cursor:default}.R44rTa_cardBrokenReason{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.R44rTa_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.R44rTa_cardMain:disabled{cursor:default}.R44rTa_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.R44rTa_cardHead{align-items:center;gap:8px;display:flex;position:relative}.R44rTa_cardName{font-size:15px;font-weight:600;line-height:1.4}.R44rTa_inUse{margin-left:auto}.R44rTa_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.R44rTa_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-tertiary);margin-top:auto;font-size:11px}.R44rTa_cardFoot{border-top:.5px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.R44rTa_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.R44rTa_iconButton:disabled{opacity:.4;cursor:default}.R44rTa_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.R44rTa_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.R44rTa_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.R44rTa_iconButton:hover:after,.R44rTa_iconButton:focus-visible:after{opacity:1}.R44rTa_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.R44rTa_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.R44rTa_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.R44rTa_revealedPathLabel{white-space:nowrap}.R44rTa_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.R44rTa_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.R44rTa_secondaryButton:disabled{opacity:.5;cursor:default}.R44rTa_field{flex-direction:column;gap:6px;display:flex}.R44rTa_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.R44rTa_input{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.R44rTa_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.R44rTa_input::placeholder{color:var(--dsw-alias-label-dimmed)}.R44rTa_dialog{width:min(560px,100%)}.R44rTa_dialogFields{flex-direction:column;gap:12px;display:flex}.R44rTa_viewerCode{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.R44rTa_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.R44rTa_deleteDialog{width:min(480px,100%)}.R44rTa_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.R44rTa_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.R44rTa_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:20px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.R44rTa_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.R44rTa_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"brokenBadge": "R44rTa_brokenBadge",
			"brokenTip": "R44rTa_brokenTip",
			"card": "R44rTa_card",
			"cardActive": "R44rTa_cardActive",
			"cardBroken": "R44rTa_cardBroken",
			"cardBrokenReason": "R44rTa_cardBrokenReason",
			"cardDesc": "R44rTa_cardDesc",
			"cardFoot": "R44rTa_cardFoot",
			"cardHead": "R44rTa_cardHead",
			"cardId": "R44rTa_cardId",
			"cardMain": "R44rTa_cardMain",
			"cardName": "R44rTa_cardName",
			"cardSelectionDisabled": "R44rTa_cardSelectionDisabled",
			"cards": "R44rTa_cards",
			"creatorButton": "R44rTa_creatorButton",
			"deleteConfirm": "R44rTa_deleteConfirm",
			"deleteDialog": "R44rTa_deleteDialog",
			"dialog": "R44rTa_dialog",
			"dialogFields": "R44rTa_dialogFields",
			"error": "R44rTa_error",
			"field": "R44rTa_field",
			"fieldLabel": "R44rTa_fieldLabel",
			"group": "R44rTa_group",
			"groupHead": "R44rTa_groupHead",
			"iconButton": "R44rTa_iconButton",
			"iconDanger": "R44rTa_iconDanger",
			"inUse": "R44rTa_inUse",
			"input": "R44rTa_input",
			"intro": "R44rTa_intro",
			"pickerPreference": "R44rTa_pickerPreference",
			"pickerPreferenceCopy": "R44rTa_pickerPreferenceCopy",
			"pickerPreferenceDescription": "R44rTa_pickerPreferenceDescription",
			"pickerPreferenceTitle": "R44rTa_pickerPreferenceTitle",
			"pickerPreferenceTitleRow": "R44rTa_pickerPreferenceTitleRow",
			"revealedPath": "R44rTa_revealedPath",
			"revealedPathLabel": "R44rTa_revealedPathLabel",
			"secondaryButton": "R44rTa_secondaryButton",
			"section": "R44rTa_section",
			"title": "R44rTa_title",
			"viewerCode": "R44rTa_viewerCode"
		};
		//#endregion
		...
		*/
		function apply(ctx) {
			...
			const seatFor = (scope, binding) => {
				let seat = seats.get(binding);
				if (seat !== void 0) return seat;
				seat = new AgentPresetSeatController(scope, () => {
					if (scope.sessions.binding(binding.sessionId) !== binding) return void 0;
					const summary = scope.sessions.list.getSnapshot().byId[binding.sessionId];
					return summary !== void 0 && (scope.sessions.retainInfo(binding.sessionId).getSnapshot().retainedBy.mainView ?? 0) > 0 ? summary : void 0;
				}, staged);
			...
			const mainBlankSeat = (scope) => {
				const summary = Object.values(scope.sessions.list.getSnapshot().byId).find((session) => {
					/* v8 ignore next -- retained source counts omit zero-valued entries. */
					return session.blank && (session.retainedBy.mainView ?? 0) > 0;
				});
				const binding = summary === void 0 ? void 0 : scope.sessions.binding(summary.id);
				return binding === void 0 ? void 0 : seatFor(scope, binding);
			};
			...
			ctx.inject([
				...
				const seatInjected = (sessionId) => {
					const binding = sessionId === void 0 ? void 0 : scope.sessions.binding(sessionId);
					const seat = binding === void 0 ? unboundSeat : seatFor(scope, binding);
					return {
			...
			const captureBlankSessionSync = () => {
				...
				const seat = binding === void 0 ? void 0 : seats.get(binding);
