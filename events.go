...
const (
	...
	EventModelInterrupted   EventType = "model.interrupted"
	EventModelSuperseded    EventType = "model.superseded"
	EventModelRestarted     EventType = "model.restarted"
	EventModelUsage         EventType = "model.usage"
	EventModelRateLimits    EventType = "model.ratelimits"
	EventModelToolCallDraft EventType = "model.tool_call_draft"
