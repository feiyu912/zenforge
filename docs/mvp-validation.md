...
| detached HTTP start/resume/status/list/attach/cancel contracts and error mappings work | `server/harnesshttp.TestDetachedStartAuthorizationMetaAndStatus`, `server/harnesshttp.TestDetachedRunsListsAuthorizedManagerSnapshots`, `server/harnesshttp.TestDetachedResumeAndAttachContinuity`, `server/harnesshttp.TestDetachedValidationAndErrorMappings`, `server/harnesshttp.TestDetachedHandlersRejectUnsupportedMethods` |
