...
4. **The console's preset selectors are answered** as of ADR 0088
...
5. **The console's own model/settings panel** (historical note). Its edits go to a host-owned settings document
